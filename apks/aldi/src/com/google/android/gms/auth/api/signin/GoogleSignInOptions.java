  ...
  implements Api.ApiOptions.Optional, ReflectedParcelable
{
  ...
  public static final class Builder
  {
    ...
    private final String zac(String paramString)
    {
      ...
      boolean bool;
      if ((this.zaab != null) && (!this.zaab.equals(paramString))) {
        bool = false;
      } else {
        bool = true;
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/google/android/gms/auth/api/signin/GoogleSignInOptions.class
