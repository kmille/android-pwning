  ...
  implements Closeable
{
  ...
  public final boolean getBoolean(String paramString, int paramInt1, int paramInt2)
  {
    ...
    return this.zalr[paramInt2].getLong(paramInt1, this.zalq.getInt(paramString)) == 1L;
  }
  ...
  public static class Builder
  {
    ...
    public Builder zaa(HashMap<String, Object> paramHashMap)
    {
      ...
      for (;;)
      {
        ...
        if (localObject != null)
        {
          localInteger = (Integer)this.zama.get(localObject);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/google/android/gms/common/data/DataHolder.class
