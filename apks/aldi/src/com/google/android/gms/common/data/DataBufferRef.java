...
public class DataBufferRef
{
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject instanceof DataBufferRef))
    {
      ...
      if ((Objects.equal(Integer.valueOf(((DataBufferRef)paramObject).mDataRow), Integer.valueOf(this.mDataRow))) && (Objects.equal(Integer.valueOf(((DataBufferRef)paramObject).zalm), Integer.valueOf(this.zalm))) && (((DataBufferRef)paramObject).mDataHolder == this.mDataHolder)) {
        return true;
      }
    }
    return false;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/google/android/gms/common/data/DataBufferRef.class
