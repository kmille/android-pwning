...
public final class $Gson$Types
{
  ...
  private static Type resolve(Type paramType1, Class<?> paramClass, Type paramType2, Collection<TypeVariable> paramCollection)
  {
    ...
    if (bool)
    {
      ...
      if (i != 0) {
        return newParameterizedTypeWithOwner((Type)localObject3, ((ParameterizedType)localObject2).getRawType(), paramType2);
      }
    ...
    implements Serializable, WildcardType
  {
    ...
    public WildcardTypeImpl(Type[] paramArrayOfType1, Type[] paramArrayOfType2)
    {
      ...
      for (paramArrayOfType1 = Object.class;; paramArrayOfType1 = .Gson.Types.canonicalize(paramArrayOfType1[0]))
      {
    ...
    public final String toString()
    {
      ...
      for (Type localType = this.lowerBound;; localType = this.upperBound)
      {
        localStringBuilder.append(.Gson.Types.typeToString(localType));
        return localStringBuilder.toString();
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/google/gson/internal/$Gson$Types.class
