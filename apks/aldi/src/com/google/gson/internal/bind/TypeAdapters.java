...
public final class TypeAdapters
{
  ...
  public static final TypeAdapter<Class> CLASS = new TypeAdapter()
  {
    ...
    public final void write(JsonWriter paramAnonymousJsonWriter, Class paramAnonymousClass)
      throws IOException
    {
      paramAnonymousJsonWriter = new StringBuilder("Attempted to serialize java.lang.Class: ");
    ...
    JSON_ELEMENT = new TypeAdapter()
    {
        ...
        throws IOException
      {
        if ((paramAnonymousJsonElement != null) && (!paramAnonymousJsonElement.isJsonNull()))
        {
          ...
          paramAnonymousJsonWriter = new StringBuilder("Couldn't write ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/google/gson/internal/bind/TypeAdapters.class
