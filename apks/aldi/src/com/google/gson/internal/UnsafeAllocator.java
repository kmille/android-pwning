    ...
    try
    {
      ...
      localObject1 = new UnsafeAllocator()
      {
          ...
          throws Exception
        {
          ...
          return (T)this.val$allocateInstance.invoke(localObject2, new Object[] { paramAnonymousClass });
        }
      };
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/google/gson/internal/UnsafeAllocator.class
