  ...
  extends BasePermissionListener
{
  ...
  private SnackbarOnDeniedPermissionListener(View paramView, String paramString1, String paramString2, View.OnClickListener paramOnClickListener, Snackbar.Callback paramCallback, int paramInt)
  {
    this.view = paramView;
  ...
  {
    super.onPermissionDenied(paramPermissionDeniedResponse);
    paramPermissionDeniedResponse = Snackbar.make(this.view, this.text, this.duration);
    if ((this.buttonText != null) && (this.onButtonClickListener != null)) {
      paramPermissionDeniedResponse.setAction(this.buttonText, this.onButtonClickListener);
    }
    if (this.snackbarCallback != null) {
      paramPermissionDeniedResponse.setCallback(this.snackbarCallback);
    }
    paramPermissionDeniedResponse.show();
  }
  ...
  public static class Builder
  {
    ...
    public Builder withOpenSettingsButton(String paramString)
    {
      ...
      this.onClickListener = new View.OnClickListener()
      {
        ...
        {
          paramAnonymousView = SnackbarOnDeniedPermissionListener.Builder.this.view.getContext();
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/com/karumi/dexter/listener/single/SnackbarOnDeniedPermissionListener.class
