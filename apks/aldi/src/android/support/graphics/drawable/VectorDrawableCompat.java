    ...
    for (int i = 1; (k != 1) && ((paramXmlPullParser.getDepth() >= m + 1) || (k != 3)); i = j)
    {
      if (k == 2)
      {
        ...
        if ("path".equals(localObject))
        {
          ...
          j = ((VFullPath)localObject).mChangingConfigurations;
        }
        for (;;)
        {
          localVectorDrawableCompatState.mChangingConfigurations = (j | k);
          j = i;
          break;
          if ("clip-path".equals(localObject))
          {
            ...
            k = localVectorDrawableCompatState.mChangingConfigurations;
            j = ((VClipPath)localObject).mChangingConfigurations;
          }
          else
          {
            j = i;
            ...
            k = localVectorDrawableCompatState.mChangingConfigurations;
            j = ((VGroup)localObject).mChangingConfigurations;
          }
        }
      }
      j = i;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/graphics/drawable/VectorDrawableCompat.class
