  ...
  extends ViewGroup
{
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if ((!localLayoutParams.isGuideline) && (!localLayoutParams.isHelper))
        {
          ...
          if ((n != 0) && (i1 != 0))
          {
            ...
            i3 = getChildMeasureSpec(paramInt1, i8, n);
            if (i1 == -2) {
              m = 1;
            } else {
              m = 0;
            }
            localView.measure(i3, getChildMeasureSpec(paramInt2, i, i1));
            if (this.mMetrics != null)
            {
          ...
          if ((m == 0) || (i == 0))
          {
            ...
            else
            {
              ...
              if (m == 0)
              {
                ...
                {
                  n = getChildMeasureSpec(paramInt1, i8, -2);
                  i5 = 0;
                  k = 1;
                  i6 = m;
                  m = n;
              ...
              else
              {
                if (m == -1)
                {
                  i1 = getChildMeasureSpec(paramInt1, i8, -1);
                  k = 0;
                  i5 = n;
                  i6 = m;
                  m = i1;
              ...
              n = 0;
              label1037:
              i = getChildMeasureSpec(paramInt2, i3, i1);
              label1046:
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (i2 != 0)
    {
      ...
      this.mLayoutWidget.optimizeForDimensions(i7, i6);
    ...
    int n = j + getPaddingBottom();
    int i10 = i + getPaddingRight();
    if (i3 > 0)
    {
      int i4;
      if (this.mLayoutWidget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
      ...
      while (i8 < i3)
      {
        ...
        if (localView != null)
        {
          ...
          {
            if ((localView.getVisibility() != 8) && ((i2 == 0) || (!((ConstraintWidget)localObject).getResolutionWidth().isResolved()) || (!((ConstraintWidget)localObject).getResolutionHeight().isResolved())))
            {
              if ((localLayoutParams.width == -2) && (localLayoutParams.horizontalDimensionFixed)) {
                i1 = getChildMeasureSpec(paramInt1, i10, localLayoutParams.width);
              } else {
                i1 = View.MeasureSpec.makeMeasureSpec(((ConstraintWidget)localObject).getWidth(), 1073741824);
              }
              if ((localLayoutParams.height == -2) && (localLayoutParams.verticalDimensionFixed)) {
                i9 = getChildMeasureSpec(paramInt2, n, localLayoutParams.height);
              } else {
                i9 = View.MeasureSpec.makeMeasureSpec(((ConstraintWidget)localObject).getHeight(), 1073741824);
              }
              localView.measure(i1, i9);
              if (this.mMetrics != null)
              {
                Metrics localMetrics = this.mMetrics;
              ...
              if (i1 != ((ConstraintWidget)localObject).getWidth())
              {
                ((ConstraintWidget)localObject).setWidth(i1);
                if (i2 != 0) {
                  ((ConstraintWidget)localObject).getResolutionWidth().resolve(i1);
                }
                m = k;
                if (i4 != 0)
                {
              ...
              if (i9 != ((ConstraintWidget)localObject).getHeight())
              {
                ...
                if (i5 != 0)
                {
                  ...
                  if (((ConstraintWidget)localObject).getBottom() > j) {
                    i1 = Math.max(j, ((ConstraintWidget)localObject).getBottom() + ((ConstraintWidget)localObject).getAnchor(ConstraintAnchor.Type.BOTTOM).getMargin());
                  }
                }
                m = 1;
              }
      ...
      if (m != 0)
      {
        this.mLayoutWidget.setWidth(i7);
    ...
    j = n;
    i = 0;
    k = this.mLayoutWidget.getWidth() + i10;
      ...
      while (i < k)
      {
        ...
        default: 
          ...
          default: 
            break;
          case 50: 
            this.editorAbsoluteY = paramAttributeSet.getDimensionPixelOffset(j, this.editorAbsoluteY);
            break;
          case 49: 
            this.editorAbsoluteX = paramAttributeSet.getDimensionPixelOffset(j, this.editorAbsoluteX);
            break;
          case 48: 
            this.verticalChainStyle = paramAttributeSet.getInt(j, 0);
            break;
          case 47: 
            this.horizontalChainStyle = paramAttributeSet.getInt(j, 0);
            break;
          case 46: 
            this.verticalWeight = paramAttributeSet.getFloat(j, this.verticalWeight);
            break;
          case 45: 
            this.horizontalWeight = paramAttributeSet.getFloat(j, this.horizontalWeight);
            break;
          case 44: 
            this.dimensionRatio = paramAttributeSet.getString(j);
            this.dimensionRatioValue = NaN.0F;
            this.dimensionRatioSide = -1;
            if (this.dimensionRatio != null)
            {
              m = this.dimensionRatio.length();
              j = this.dimensionRatio.indexOf(',');
              if ((j > 0) && (j < m - 1))
              {
                paramContext = this.dimensionRatio.substring(0, j);
                if (paramContext.equalsIgnoreCase("W")) {
                  this.dimensionRatioSide = 0;
                } else if (paramContext.equalsIgnoreCase("H")) {
                  this.dimensionRatioSide = 1;
                }
                j += 1;
              }
              ...
              if ((n >= 0) && (n < m - 1))
              {
                paramContext = this.dimensionRatio.substring(j, n);
                str = this.dimensionRatio.substring(n + 1);
                if ((paramContext.length() <= 0) || (str.length() <= 0)) {
                  break;
                }
              }
            }
        ...
        for (;;)
        {
          try
          {
            float f1 = Float.parseFloat(paramContext);
            float f2 = Float.parseFloat(str);
            if ((f1 > 0.0F) && (f2 > 0.0F)) {
              if (this.dimensionRatioSide == 1)
              {
                f1 = Math.abs(f2 / f1);
                this.dimensionRatioValue = f1;
              }
              else
              {
                f1 = Math.abs(f1 / f2);
                continue;
                paramContext = this.dimensionRatio.substring(j);
                if (paramContext.length() > 0)
                {
                  f1 = Float.parseFloat(paramContext);
                  continue;
                  this.matchConstraintPercentHeight = Math.max(0.0F, paramAttributeSet.getFloat(j, this.matchConstraintPercentHeight));
                }
              }
            }
          }
          ...
          try
          {
            this.matchConstraintMaxHeight = paramAttributeSet.getDimensionPixelSize(j, this.matchConstraintMaxHeight);
          }
          catch (Exception paramContext) {}
        }
        if (paramAttributeSet.getInt(j, this.matchConstraintMaxHeight) == -2) {
          this.matchConstraintMaxHeight = -2;
        }
        try
        {
          this.matchConstraintMinHeight = paramAttributeSet.getDimensionPixelSize(j, this.matchConstraintMinHeight);
        }
        catch (Exception paramContext)
        {
          label1211:
        ...
        if (paramAttributeSet.getInt(j, this.matchConstraintMinHeight) == -2)
        {
          this.matchConstraintMinHeight = -2;
          break label2024;
          this.matchConstraintPercentWidth = Math.max(0.0F, paramAttributeSet.getFloat(j, this.matchConstraintPercentWidth));
        }
        try
        {
          this.matchConstraintMaxWidth = paramAttributeSet.getDimensionPixelSize(j, this.matchConstraintMaxWidth);
        }
        catch (Exception paramContext)
        {
          for (;;) {}
        }
        if (paramAttributeSet.getInt(j, this.matchConstraintMaxWidth) == -2) {
          this.matchConstraintMaxWidth = -2;
        }
        try
        {
          this.matchConstraintMinWidth = paramAttributeSet.getDimensionPixelSize(j, this.matchConstraintMinWidth);
        }
        catch (Exception paramContext)
        {
          for (;;) {}
        }
        if (paramAttributeSet.getInt(j, this.matchConstraintMinWidth) == -2)
        {
          this.matchConstraintMinWidth = -2;
          break label2024;
          this.matchConstraintDefaultHeight = paramAttributeSet.getInt(j, 0);
          if (this.matchConstraintDefaultHeight == 1)
          {
            paramContext = "layout_constraintHeight_default=\"wrap\" is deprecated.\nUse layout_height=\"WRAP_CONTENT\" and layout_constrainedHeight=\"true\" instead.";
            break label1211;
            this.matchConstraintDefaultWidth = paramAttributeSet.getInt(j, 0);
            if (this.matchConstraintDefaultWidth == 1)
            {
              paramContext = "layout_constraintWidth_default=\"wrap\" is deprecated.\nUse layout_width=\"WRAP_CONTENT\" and layout_constrainedWidth=\"true\" instead.";
              Log.e("ConstraintLayout", paramContext);
              break label2024;
              this.verticalBias = paramAttributeSet.getFloat(j, this.verticalBias);
              break label2024;
              this.horizontalBias = paramAttributeSet.getFloat(j, this.horizontalBias);
              break label2024;
              this.constrainedHeight = paramAttributeSet.getBoolean(j, this.constrainedHeight);
              break label2024;
              this.constrainedWidth = paramAttributeSet.getBoolean(j, this.constrainedWidth);
              break label2024;
              this.goneEndMargin = paramAttributeSet.getDimensionPixelSize(j, this.goneEndMargin);
              break label2024;
              this.goneStartMargin = paramAttributeSet.getDimensionPixelSize(j, this.goneStartMargin);
              break label2024;
              this.goneBottomMargin = paramAttributeSet.getDimensionPixelSize(j, this.goneBottomMargin);
              break label2024;
              this.goneRightMargin = paramAttributeSet.getDimensionPixelSize(j, this.goneRightMargin);
              break label2024;
              this.goneTopMargin = paramAttributeSet.getDimensionPixelSize(j, this.goneTopMargin);
              break label2024;
              this.goneLeftMargin = paramAttributeSet.getDimensionPixelSize(j, this.goneLeftMargin);
              break label2024;
              this.endToEnd = paramAttributeSet.getResourceId(j, this.endToEnd);
              if (this.endToEnd == -1)
              {
                this.endToEnd = paramAttributeSet.getInt(j, -1);
                break label2024;
                this.endToStart = paramAttributeSet.getResourceId(j, this.endToStart);
                if (this.endToStart == -1)
                {
                  this.endToStart = paramAttributeSet.getInt(j, -1);
                  break label2024;
                  this.startToStart = paramAttributeSet.getResourceId(j, this.startToStart);
                  if (this.startToStart == -1)
                  {
                    this.startToStart = paramAttributeSet.getInt(j, -1);
                    break label2024;
                    this.startToEnd = paramAttributeSet.getResourceId(j, this.startToEnd);
                    if (this.startToEnd == -1)
                    {
                      this.startToEnd = paramAttributeSet.getInt(j, -1);
                      break label2024;
                      this.baselineToBaseline = paramAttributeSet.getResourceId(j, this.baselineToBaseline);
                      if (this.baselineToBaseline == -1)
                      {
                        this.baselineToBaseline = paramAttributeSet.getInt(j, -1);
                        break label2024;
                        this.bottomToBottom = paramAttributeSet.getResourceId(j, this.bottomToBottom);
                        if (this.bottomToBottom == -1)
                        {
                          this.bottomToBottom = paramAttributeSet.getInt(j, -1);
                          break label2024;
                          this.bottomToTop = paramAttributeSet.getResourceId(j, this.bottomToTop);
                          if (this.bottomToTop == -1)
                          {
                            this.bottomToTop = paramAttributeSet.getInt(j, -1);
                            break label2024;
                            this.topToBottom = paramAttributeSet.getResourceId(j, this.topToBottom);
                            if (this.topToBottom == -1)
                            {
                              this.topToBottom = paramAttributeSet.getInt(j, -1);
                              break label2024;
                              this.topToTop = paramAttributeSet.getResourceId(j, this.topToTop);
                              if (this.topToTop == -1)
                              {
                                this.topToTop = paramAttributeSet.getInt(j, -1);
                                break label2024;
                                this.rightToRight = paramAttributeSet.getResourceId(j, this.rightToRight);
                                if (this.rightToRight == -1)
                                {
                                  this.rightToRight = paramAttributeSet.getInt(j, -1);
                                  break label2024;
                                  this.rightToLeft = paramAttributeSet.getResourceId(j, this.rightToLeft);
                                  if (this.rightToLeft == -1)
                                  {
                                    this.rightToLeft = paramAttributeSet.getInt(j, -1);
                                    break label2024;
                                    this.leftToRight = paramAttributeSet.getResourceId(j, this.leftToRight);
                                    if (this.leftToRight == -1)
                                    {
                                      this.leftToRight = paramAttributeSet.getInt(j, -1);
                                      break label2024;
                                      this.leftToLeft = paramAttributeSet.getResourceId(j, this.leftToLeft);
                                      if (this.leftToLeft == -1)
                                      {
                                        this.leftToLeft = paramAttributeSet.getInt(j, -1);
                                        break label2024;
                                        this.guidePercent = paramAttributeSet.getFloat(j, this.guidePercent);
                                        break label2024;
                                        this.guideEnd = paramAttributeSet.getDimensionPixelOffset(j, this.guideEnd);
                                        break label2024;
                                        this.guideBegin = paramAttributeSet.getDimensionPixelOffset(j, this.guideBegin);
                                        break label2024;
                                        this.circleAngle = (paramAttributeSet.getFloat(j, this.circleAngle) % 360.0F);
                                        if (this.circleAngle < 0.0F)
                                        {
                                          this.circleAngle = ((360.0F - this.circleAngle) % 360.0F);
                                          break label2024;
                                          this.circleRadius = paramAttributeSet.getDimensionPixelSize(j, this.circleRadius);
                                          break label2024;
                                          this.circleConstraint = paramAttributeSet.getResourceId(j, this.circleConstraint);
                                          if (this.circleConstraint == -1)
                                          {
                                            this.circleConstraint = paramAttributeSet.getInt(j, -1);
                                            break label2024;
                                            this.orientation = paramAttributeSet.getInt(j, this.orientation);
                                          }
                                        }
                                      }
                                    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/ConstraintLayout.class
