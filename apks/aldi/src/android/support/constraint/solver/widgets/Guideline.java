  ...
  extends ConstraintWidget
{
  ...
  public void setOrientation(int paramInt)
  {
    ...
    this.mAnchors.clear();
    if (this.mOrientation == 1) {}
    for (ConstraintAnchor localConstraintAnchor = this.mLeft;; localConstraintAnchor = this.mTop)
    {
      this.mAnchor = localConstraintAnchor;
      break;
    }
    this.mAnchors.add(this.mAnchor);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/solver/widgets/Guideline.class
