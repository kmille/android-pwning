  ...
  extends ResolutionNode
{
  ...
  public void resolve()
  {
    ...
    if ((this.type == 1) && ((this.target == null) || (this.target.state == 1)))
    {
      ...
      for (f1 = this.offset;; f1 = this.target.resolvedOffset + this.offset)
      {
        this.resolvedOffset = f1;
        break;
    ...
    if ((this.type == 2) && (this.target != null) && (this.target.state == 1) && (this.opposite != null) && (this.opposite.target != null) && (this.opposite.target.state == 1))
    {
      ...
      for (localObject = this.opposite.target;; localObject = this.target)
      {
    ...
    for (this.opposite.resolvedOffset = (this.opposite.target.resolvedOffset - f4 - f2 * (1.0F - f1));; this.opposite.resolvedOffset = (this.opposite.target.resolvedOffset + this.opposite.offset))
    {
      didResolve();
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/solver/widgets/ResolutionAnchor.class
