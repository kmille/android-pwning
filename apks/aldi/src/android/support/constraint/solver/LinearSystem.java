...
public class LinearSystem
{
  ...
  private SolverVariable acquireSolverVariable(SolverVariable.Type paramType, String paramString)
  {
    ...
    paramType = this.mPoolVariables;
    int i = this.mPoolVariablesCount;
    this.mPoolVariablesCount = (i + 1);
    paramType[i] = localSolverVariable;
  ...
  {
    Object localObject = new StringBuilder("Display Rows (");
  ...
  void displaySystemInformations()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("Linear System -> Table size: ");
    ...
    localStringBuilder.append(" 0 occupied cells, ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/solver/LinearSystem.class
