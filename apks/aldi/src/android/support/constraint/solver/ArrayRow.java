  ...
  implements LinearSystem.Row
{
  ...
  ArrayRow createRowCentering(SolverVariable paramSolverVariable1, SolverVariable paramSolverVariable2, int paramInt1, float paramFloat, SolverVariable paramSolverVariable3, SolverVariable paramSolverVariable4, int paramInt2)
  {
    ...
    if (paramFloat == 0.5F)
    {
      ...
      if ((paramInt1 > 0) || (paramInt2 > 0)) {
        paramFloat = -paramInt1 + paramInt2;
      }
    }
    else
    {
  ...
  {
    ArrayLinkedVariables localArrayLinkedVariables;
    if (paramInt < 0)
    {
      this.constantValue = (paramInt * -1);
      localArrayLinkedVariables = this.variables;
    }
    for (float f = 1.0F;; f = -1.0F)
    {
      localArrayLinkedVariables.put(paramSolverVariable, f);
      return this;
  ...
  String toReadableString()
  {
    ...
    int m = this.variables.currentSize;
    while (j < m)
    {
      Object localObject3 = this.variables.getVariable(j);
      int k = i;
      ...
      if (localObject3 != null)
      {
        ...
        if (f2 != 0.0F)
        {
          String str = ((SolverVariable)localObject3).toString();
          if (i == 0)
          {
            localObject2 = localObject1;
            f1 = f2;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/solver/ArrayRow.class
