    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      while (i < j)
      {
        ...
        else
        {
          ...
          for (float f = this.translationX;; f = this.translationZ)
          {
            this.translationX = paramContext.getFloat(k, f);
            break;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/Constraints.class
