...
public class ConstraintSet
{
  ...
  private void populateConstraint(Constraint paramConstraint, TypedArray paramTypedArray)
  {
    ...
    while (i < j)
    {
      ...
      default: 
        ...
        default: 
        case 64: 
          for (StringBuilder localStringBuilder = new StringBuilder("Unknown attribute 0x");; localStringBuilder = new StringBuilder("unused attribute 0x"))
          {
  ...
  public void centerHorizontally(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      center(paramInt1, paramInt2, i, 0, j, k, 0, 0.5F);
      return;
      int m = 2;
      k = 1;
      i = paramInt2;
    ...
    while (i < j)
    {
      ...
      if (k != -1)
      {
        ...
        if (Build.VERSION.SDK_INT >= 17)
        {
          ...
          localConstraint.rotation = localView.getRotation();
  ...
  public void connect(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    case 7: 
      ...
      localObject = new StringBuilder("right to ");
      ((StringBuilder)localObject).append(sideToString(paramInt4));
    ...
    localObject = new StringBuilder("left to ");
    ((StringBuilder)localObject).append(sideToString(paramInt4));
    ((StringBuilder)localObject).append(" undefined");
    throw new IllegalArgumentException(((StringBuilder)localObject).toString());
  }
  ...
  public void removeFromHorizontalChain(int paramInt)
  {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt)))
    {
      ...
      int n = localConstraint.rightToLeft;
      int k;
      int j;
      int m;
      if ((i == -1) && (n == -1))
  ...
  public void removeFromVerticalChain(int paramInt)
  {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt)))
    {
      ...
      int n = localConstraint.bottomToTop;
      if ((i != -1) || (n != -1))
      {
        int j;
        int m;
        ...
        for (;;)
        {
          ...
          {
            j = 4;
            k = localConstraint.bottomToBottom;
            m = 4;
          }
          else
          {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/constraint/ConstraintSet.class
