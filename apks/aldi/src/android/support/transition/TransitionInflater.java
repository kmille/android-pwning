...
public class TransitionInflater
{
  ...
  private Object createCustom(AttributeSet paramAttributeSet, Class paramClass, String paramString)
  {
    ...
    if (str != null) {
      ...
      {
        paramString = new StringBuilder("Could not instantiate ");
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        ...
        {
          if ("arcMotion".equals(localObject1)) {
            if (paramTransition != null) {
              localObject1 = new ArcMotion(this.mContext, paramAttributeSet);
            }
          }
          for (;;)
          {
            paramTransition.setPathMotion((PathMotion)localObject1);
            localObject1 = localObject2;
            break;
            throw new RuntimeException("Invalid use of arcMotion element");
            if ("pathMotion".equals(localObject1))
            {
              if (paramTransition != null) {
                localObject1 = (PathMotion)createCustom(paramAttributeSet, PathMotion.class, "pathMotion");
              } else {
            ...
            else
            {
              ...
              localObject1 = new PatternPathMotion(this.mContext, paramAttributeSet);
            }
          }
        }
    ...
    label593:
    paramAttributeSet = new StringBuilder("Unknown scene name: ");
    ...
    throws XmlPullParserException, IOException
  {
    ...
    localTypedArray.recycle();
    throw new RuntimeException("Could not create ".concat(String.valueOf(paramXmlPullParser)), paramAttributeSet);
    label285:
    paramAttributeSet = new StringBuilder("Unknown scene name: ");
    paramAttributeSet.append(paramXmlPullParser.getName());
    throw new RuntimeException(paramAttributeSet.toString());
    ...
    if (i >= 0)
    {
      ...
      if (paramViewGroup != null) {
        if (paramXmlPullParser != null)
        {
          ...
          throw new RuntimeException("No toScene for transition ID ".concat(String.valueOf(i)));
        }
      }
    }
    localTypedArray.recycle();
  ...
  public Transition inflateTransition(int paramInt)
  {
    ...
    //   4: invokevirtual 365	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   7: iload_1
    //   8: invokevirtual 371	android/content/res/Resources:getXml	(I)Landroid/content/res/XmlResourceParser;
    //   11: astore_2
    //   12: aload_0
    //   13: aload_2
    //   14: aload_2
    //   15: invokestatic 377	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   18: aconst_null
    //   19: invokespecial 230	android/support/transition/TransitionInflater:createTransitionFromXml	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
    //   22: astore_3
    //   23: aload_2
    //   24: invokeinterface 382 1 0
    //   29: aload_3
    //   30: areturn
    //   31: astore_3
    //   32: goto +72 -> 104
    ...
    //   66: aload 4
    //   68: aload_3
    //   69: invokevirtual 390	java/io/IOException:getMessage	()Ljava/lang/String;
    //   72: invokevirtual 98	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   75: pop
    //   76: new 100	android/view/InflateException
    //   79: dup
    //   80: aload 4
    //   82: invokevirtual 104	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   85: aload_3
    //   86: invokespecial 107	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   89: athrow
    //   90: astore_3
    //   91: new 100	android/view/InflateException
    //   94: dup
    //   95: aload_3
    //   96: invokevirtual 391	org/xmlpull/v1/XmlPullParserException:getMessage	()Ljava/lang/String;
    //   99: aload_3
    //   100: invokespecial 107	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   103: athrow
    //   104: aload_2
    //   105: invokeinterface 382 1 0
    //   110: aload_3
    //   111: athrow
  ...
  public TransitionManager inflateTransitionManager(int paramInt, ViewGroup paramViewGroup)
  {
    ...
    //   15: invokestatic 377	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   18: aload_2
    //   19: invokespecial 395	android/support/transition/TransitionInflater:createTransitionManagerFromXml	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/support/transition/TransitionManager;
    //   22: astore_2
    //   23: aload_3
    //   24: invokeinterface 382 1 0
    //   29: aload_2
    ...
    //   80: aload 4
    //   82: invokevirtual 104	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   85: invokespecial 111	android/view/InflateException:<init>	(Ljava/lang/String;)V
    //   88: astore 4
    //   90: aload 4
    //   92: aload_2
    //   93: invokevirtual 399	android/view/InflateException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   96: pop
    //   97: aload 4
    //   99: athrow
    //   100: astore_2
    ...
    //   104: dup
    //   105: aload_2
    //   106: invokevirtual 391	org/xmlpull/v1/XmlPullParserException:getMessage	()Ljava/lang/String;
    //   109: invokespecial 111	android/view/InflateException:<init>	(Ljava/lang/String;)V
    //   112: astore 4
    //   114: aload 4
    //   116: aload_2
    //   117: invokevirtual 399	android/view/InflateException:initCause	(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    //   120: pop
    //   121: aload 4
    //   123: athrow
    //   124: aload_3
    //   125: invokeinterface 382 1 0
    //   130: aload_2
    //   131: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/transition/TransitionInflater.class
