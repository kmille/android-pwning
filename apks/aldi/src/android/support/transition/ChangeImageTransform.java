  ...
  extends Transition
{
  ...
  {
    public final Matrix get(ImageView paramAnonymousImageView)
    {
      return null;
    }
    
    public final void set(ImageView paramAnonymousImageView, Matrix paramAnonymousMatrix)
    {
  ...
  static
  {
    ...
    {
      public final Matrix evaluate(float paramAnonymousFloat, Matrix paramAnonymousMatrix1, Matrix paramAnonymousMatrix2)
      {
        return null;
      }
    };
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/transition/ChangeImageTransform.class
