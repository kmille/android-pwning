  ...
  implements Cloneable
{
  ...
  private void captureHierarchy(View paramView, boolean paramBoolean)
  {
    ...
    if ((paramView.getParent() instanceof ViewGroup))
    {
      ...
      if (paramBoolean) {}
      for (localObject = this.mStartValues;; localObject = this.mEndValues)
      {
        addViewValues((TransitionValuesMaps)localObject, paramView, localTransitionValues);
        break;
      }
    }
  ...
  void captureValues(ViewGroup paramViewGroup, boolean paramBoolean)
  {
    ...
    else
    {
      ...
      {
        localObject2 = paramViewGroup.findViewById(((Integer)this.mTargetIds.get(i)).intValue());
        if (localObject2 != null)
        {
          TransitionValues localTransitionValues = new TransitionValues();
          localTransitionValues.view = ((View)localObject2);
          if (paramBoolean) {
            captureStartValues(localTransitionValues);
          } else {
            captureEndValues(localTransitionValues);
          ...
          capturePropagationValues(localTransitionValues);
          if (paramBoolean) {}
          for (localObject1 = this.mStartValues;; localObject1 = this.mEndValues)
          {
            addViewValues((TransitionValuesMaps)localObject1, (View)localObject2, localTransitionValues);
            break;
          }
        }
        i += 1;
      ...
      while (i < this.mTargets.size())
      {
        ...
        if (paramBoolean) {}
        for (paramViewGroup = this.mStartValues;; paramViewGroup = this.mEndValues)
        {
          addViewValues(paramViewGroup, (View)localObject1, (TransitionValues)localObject2);
          break;
        }
        i += 1;
      }
  ...
  void clearValues(boolean paramBoolean)
  {
    ...
    {
      localTransitionValuesMaps.mItemIdValues.clear();
      return;
  ...
  protected void createAnimators(ViewGroup paramViewGroup, TransitionValuesMaps paramTransitionValuesMaps1, TransitionValuesMaps paramTransitionValuesMaps2, ArrayList<TransitionValues> paramArrayList1, ArrayList<TransitionValues> paramArrayList2)
  {
    ...
    while (i < k)
    {
      ...
      do
      {
        ...
        localObject1 = createAnimator(paramViewGroup, (TransitionValues)localObject2, localTransitionValuesMaps);
      } while (localObject1 == null);
      Object localObject3;
      if (localTransitionValuesMaps != null)
      {
        View localView = localTransitionValuesMaps.view;
        ...
        if ((localView != null) && (arrayOfString != null) && (arrayOfString.length > 0))
        {
          ...
          ((TransitionValues)localObject3).view = localView;
          paramTransitionValuesMaps1 = (TransitionValues)paramTransitionValuesMaps2.mViewValues.get(localView);
          j = i;
          if (paramTransitionValuesMaps1 != null)
          {
            m = 0;
            for (;;)
            {
              ...
              ((TransitionValues)localObject3).values.put(arrayOfString[m], paramTransitionValuesMaps1.values.get(arrayOfString[m]));
              m += 1;
            }
          }
          i = j;
          ...
          for (;;)
          {
            ...
            paramTransitionValuesMaps1 = (AnimationInfo)localArrayMap.get((Animator)localArrayMap.keyAt(m));
            if ((paramTransitionValuesMaps1.mValues != null) && (paramTransitionValuesMaps1.mView == localView) && (paramTransitionValuesMaps1.mName.equals(getName())) && (paramTransitionValuesMaps1.mValues.equals(localObject3)))
            {
              paramTransitionValuesMaps1 = (TransitionValuesMaps)localObject3;
              localObject1 = null;
      ...
      if (localObject1 != null)
      {
        ...
        localArrayMap.put(localObject1, new AnimationInfo((View)localObject3, getName(), this, ViewUtils.getWindowId(paramViewGroup), paramTransitionValuesMaps1));
  ...
  public void setMatchOrder(int... paramVarArgs)
  {
    ...
    for (paramVarArgs = (int[])paramVarArgs.clone();; paramVarArgs = DEFAULT_MATCH_ORDER)
    {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/transition/Transition.class
