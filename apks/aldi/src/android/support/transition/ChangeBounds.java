  ...
  extends Transition
{
  ...
  {
    public final PointF get(View paramAnonymousView)
    {
      return null;
    }
    
    public final void set(View paramAnonymousView, PointF paramAnonymousPointF)
    {
  ...
  static
  {
    DRAWABLE_ORIGIN_PROPERTY = new Property(PointF.class, "boundsOrigin")
    {
      ...
      public final PointF get(Drawable paramAnonymousDrawable)
      {
        paramAnonymousDrawable.copyBounds(this.mBounds);
        return new PointF(this.mBounds.left, this.mBounds.top);
      }
      
      public final void set(Drawable paramAnonymousDrawable, PointF paramAnonymousPointF)
      {
        paramAnonymousDrawable.copyBounds(this.mBounds);
    ...
    {
      public final PointF get(ChangeBounds.ViewBounds paramAnonymousViewBounds)
      {
        return null;
      }
      
      public final void set(ChangeBounds.ViewBounds paramAnonymousViewBounds, PointF paramAnonymousPointF)
      {
        ...
        if (parentMatches((View)localObject2, (View)localObject3))
        {
          ...
          if (j > 0)
          {
            if (!this.mResizeClip)
            {
              ...
              ViewUtils.setLeftTopRightBottom(paramTransitionValues2, k, n, i2, i4);
              if (j == 2)
              {
                if ((i6 == i8) && (i7 == i9))
                {
                  paramViewGroup = getPathMotion().getPath(k, n, m, i1);
                  paramTransitionValues1 = POSITION_PROPERTY;
                }
                else
                {
                  paramTransitionValues1 = new ViewBounds(paramTransitionValues2);
                  paramViewGroup = getPathMotion().getPath(k, n, m, i1);
              ...
              {
                paramViewGroup = getPathMotion().getPath(i2, i4, i3, i5);
                paramTransitionValues1 = BOTTOM_RIGHT_ONLY_PROPERTY;
              }
              else
              {
                paramViewGroup = getPathMotion().getPath(k, n, m, i1);
                paramTransitionValues1 = TOP_LEFT_ONLY_PROPERTY;
              }
              paramViewGroup = ObjectAnimatorUtils.ofPointF(paramTransitionValues2, paramTransitionValues1, paramViewGroup);
            }
            else
            {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/transition/ChangeBounds.class
