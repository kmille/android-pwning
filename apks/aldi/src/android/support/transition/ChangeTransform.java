  ...
  extends Transition
{
  ...
  static
  {
    ...
    {
      public final float[] get(ChangeTransform.PathAnimatorMatrix paramAnonymousPathAnimatorMatrix)
      {
        return null;
      }
      
      public final void set(ChangeTransform.PathAnimatorMatrix paramAnonymousPathAnimatorMatrix, float[] paramAnonymousArrayOfFloat)
      {
    ...
    {
      public final PointF get(ChangeTransform.PathAnimatorMatrix paramAnonymousPathAnimatorMatrix)
      {
        return null;
      }
      
      public final void set(ChangeTransform.PathAnimatorMatrix paramAnonymousPathAnimatorMatrix, PointF paramAnonymousPointF)
      {
  ...
  static class Transforms
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      return (((Transforms)paramObject).mTranslationX == this.mTranslationX) && (((Transforms)paramObject).mTranslationY == this.mTranslationY) && (((Transforms)paramObject).mTranslationZ == this.mTranslationZ) && (((Transforms)paramObject).mScaleX == this.mScaleX) && (((Transforms)paramObject).mScaleY == this.mScaleY) && (((Transforms)paramObject).mRotationX == this.mRotationX) && (((Transforms)paramObject).mRotationY == this.mRotationY) && (((Transforms)paramObject).mRotationZ == this.mRotationZ);
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/transition/ChangeTransform.class
