    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      if (this.mEntryValid)
      {
        ...
        paramObject = (Map.Entry)paramObject;
        return (ContainerHelpers.equal(((Map.Entry)paramObject).getKey(), MapCollections.this.colGetEntry(this.mIndex, 0))) && (ContainerHelpers.equal(((Map.Entry)paramObject).getValue(), MapCollections.this.colGetEntry(this.mIndex, 1)));
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/util/MapCollections.class
