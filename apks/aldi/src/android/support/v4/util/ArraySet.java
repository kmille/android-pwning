  ...
  implements Collection<E>, Set<E>
{
  ...
  public final boolean add(@Nullable E paramE)
  {
    int i;
    int j;
    if (paramE == null)
  ...
  public final void addAll(@NonNull ArraySet<? extends E> paramArraySet)
  {
  ...
  public final boolean addAll(@NonNull Collection<? extends E> paramCollection)
  {
  ...
  public final boolean containsAll(@NonNull Collection<?> paramCollection)
  {
    paramCollection = paramCollection.iterator();
    while (paramCollection.hasNext()) {
  ...
  public final boolean removeAll(@NonNull ArraySet<? extends E> paramArraySet)
  {
    int j = paramArraySet.mSize;
    int k = this.mSize;
    int i = 0;
  ...
  public final boolean removeAll(@NonNull Collection<?> paramCollection)
  {
    paramCollection = paramCollection.iterator();
    boolean bool = false;
    while (paramCollection.hasNext()) {
  ...
  public final boolean retainAll(@NonNull Collection<?> paramCollection)
  {
    int i = this.mSize - 1;
    boolean bool = false;
    while (i >= 0)
  ...
  @NonNull
  public final <T> T[] toArray(@NonNull T[] paramArrayOfT)
  {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/util/ArraySet.class
