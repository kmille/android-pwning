...
public class Preconditions
{
  ...
  public static int checkFlagsArgument(int paramInt1, int paramInt2)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("Requested flags 0x");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/util/Preconditions.class
