  ...
  implements NotificationBuilderWithBuilderAccessor
{
  ...
  NotificationCompatBuilder(NotificationCompat.Builder paramBuilder)
  {
    ...
    for (Object localObject1 = new Notification.Builder(paramBuilder.mContext, paramBuilder.mChannelId);; localObject1 = new Notification.Builder(paramBuilder.mContext))
    {
      this.mBuilder = ((Notification.Builder)localObject1);
      break;
    }
    Notification localNotification = paramBuilder.mNotification;
    localObject1 = this.mBuilder.setWhen(localNotification.when).setSmallIcon(localNotification.icon, localNotification.iconLevel).setContent(localNotification.contentView).setTicker(localNotification.tickerText, paramBuilder.mTickerView).setVibrate(localNotification.vibrate).setLights(localNotification.ledARGB, localNotification.ledOnMS, localNotification.ledOffMS);
    boolean bool;
    ...
    if (Build.VERSION.SDK_INT >= 16)
    {
      ...
      if (Build.VERSION.SDK_INT < 20)
      {
        ...
        if (paramBuilder.mGroupKey != null)
        {
          ...
          for (localObject2 = "android.support.isGroupSummary";; localObject2 = "android.support.useSideChannel")
          {
            ((Bundle)localObject1).putBoolean((String)localObject2, true);
            break;
            localObject1 = this.mExtras;
          }
        }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/NotificationCompatBuilder.class
