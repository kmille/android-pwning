  ...
  implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator
{
  ...
  public final FragmentTransaction add(int paramInt, Fragment paramFragment, @Nullable String paramString)
  {
    doAddOp(paramInt, paramFragment, paramString, 1);
    return this;
  }
  
  public final FragmentTransaction add(Fragment paramFragment, @Nullable String paramString)
  {
  ...
  public final FragmentTransaction addSharedElement(View paramView, String paramString)
  {
    if (FragmentTransition.supportsTransition())
    {
      ...
      if (paramView != null)
      {
        ...
        return this;
        label89:
        paramString = new StringBuilder("A shared element with the source name '");
        paramString.append(paramView);
        paramString.append(" has already been added to the transaction.");
        throw new IllegalArgumentException(paramString.toString());
        label126:
        paramView = new StringBuilder("A shared element with the target name '");
  ...
  public final FragmentTransaction addToBackStack(@Nullable String paramString)
  {
  ...
  final int commitInternal(boolean paramBoolean)
  {
    if (!this.mCommitted)
    {
      ...
      if (this.mAddToBackStack) {}
      for (int i = this.mManager.allocBackStackIndex(this);; i = -1)
      {
        this.mIndex = i;
        break;
      }
  ...
  final void executeOps()
  {
    ...
    while (i < j)
    {
      ...
      if (k != 1)
      {
        ...
        {
        default: 
          localObject = new StringBuilder("Unknown cmd: ");
          ((StringBuilder)localObject).append(localOp.cmd);
          throw new IllegalArgumentException(((StringBuilder)localObject).toString());
        case 9: 
  ...
  public final FragmentTransaction replace(int paramInt, Fragment paramFragment, @Nullable String paramString)
  {
    if (paramInt != 0)
    {
  ...
  public final FragmentTransaction setBreadCrumbShortTitle(@Nullable CharSequence paramCharSequence)
  {
  ...
  public final FragmentTransaction setBreadCrumbTitle(@Nullable CharSequence paramCharSequence)
  {
  ...
  public final FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment paramFragment)
  {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
