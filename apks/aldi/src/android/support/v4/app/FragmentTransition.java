...
class FragmentTransition
{
  ...
  static View getInEpicenterView(ArrayMap<String, View> paramArrayMap, FragmentContainerTransition paramFragmentContainerTransition, Object paramObject, boolean paramBoolean)
  {
    ...
    {
      if (paramBoolean) {}
      for (paramFragmentContainerTransition = paramFragmentContainerTransition.mSharedElementSourceNames;; paramFragmentContainerTransition = paramFragmentContainerTransition.mSharedElementTargetNames)
      {
        paramFragmentContainerTransition = (String)paramFragmentContainerTransition.get(0);
        break;
      }
  ...
  private static void setOutEpicenter(FragmentTransitionImpl paramFragmentTransitionImpl, Object paramObject1, Object paramObject2, ArrayMap<String, View> paramArrayMap, boolean paramBoolean, BackStackRecord paramBackStackRecord)
  {
    ...
    {
      if (paramBoolean) {}
      for (paramBackStackRecord = paramBackStackRecord.mSharedElementTargetNames;; paramBackStackRecord = paramBackStackRecord.mSharedElementSourceNames)
      {
        paramBackStackRecord = (String)paramBackStackRecord.get(0);
        break;
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/FragmentTransition.class
