  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  public LayoutInflater onGetLayoutInflater(@Nullable Bundle paramBundle)
  {
    ...
    for (paramBundle = this.mDialog.getContext();; paramBundle = this.mHost.getContext()) {
      return (LayoutInflater)paramBundle.getSystemService("layout_inflater");
    }
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/DialogFragment.class
