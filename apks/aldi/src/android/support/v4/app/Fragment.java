  ...
  implements LifecycleOwner, ViewModelStoreOwner, ComponentCallbacks, View.OnCreateContextMenuListener
{
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString)
  {
    ...
    {
      paramPrintWriter.print(paramString);
      Object localObject = new StringBuilder("Child ");
  ...
  void performDetach()
  {
    ...
    if (this.mCalled)
    {
      if (this.mChildFragmentManager != null)
      {
        ...
        localStringBuilder = new StringBuilder("Child FragmentManager of ");
        localStringBuilder.append(this);
  ...
  public final void requestPermissions(@NonNull String[] paramArrayOfString, int paramInt)
  {
    ...
    paramArrayOfString = new StringBuilder("Fragment ");
  ...
  final void setIndex(int paramInt, Fragment paramFragment)
  {
    ...
    for (paramFragment = localStringBuilder;; paramFragment = new StringBuilder("android:fragment:"))
    {
    ...
    throws IntentSender.SendIntentException
  {
    ...
    paramIntentSender = new StringBuilder("Fragment ");
    ...
    implements Parcelable
  {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator()
    {
      ...
      public final Fragment.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/Fragment.class
