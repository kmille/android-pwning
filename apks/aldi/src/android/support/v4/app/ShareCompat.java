...
public final class ShareCompat
{
  ...
  public static void configureMenuItem(Menu paramMenu, int paramInt, IntentBuilder paramIntentBuilder)
  {
    ...
    paramMenu = new StringBuilder("Could not find menu item with id ");
  ...
  public static void configureMenuItem(MenuItem paramMenuItem, IntentBuilder paramIntentBuilder)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(".sharecompat_");
  ...
  public static class IntentReader
  {
    ...
    public Uri getStream(int paramInt)
    {
      ...
      if (this.mStreams != null) {}
      for (Object localObject = this.mStreams.get(paramInt);; localObject = this.mIntent.getParcelableExtra("android.intent.extra.STREAM"))
      {
      ...
      localObject = new StringBuilder("Stream items available: ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/ShareCompat.class
