...
public class NotificationCompat
{
  ...
  public static String getGroup(Notification paramNotification)
  {
    ...
    if (Build.VERSION.SDK_INT >= 19) {}
    for (paramNotification = paramNotification.extras;; paramNotification = NotificationCompatJellybean.getExtras(paramNotification))
    {
      return paramNotification.getString("android.support.groupKey");
      if (Build.VERSION.SDK_INT < 16) {
        break;
      }
    }
  ...
  public static boolean getLocalOnly(Notification paramNotification)
  {
    ...
    for (paramNotification = paramNotification.extras;; paramNotification = NotificationCompatJellybean.getExtras(paramNotification))
    {
      return paramNotification.getBoolean("android.support.localOnly");
      if (Build.VERSION.SDK_INT < 16) {
        break;
      }
    }
  ...
  public static String getSortKey(Notification paramNotification)
  {
    ...
    for (paramNotification = paramNotification.extras;; paramNotification = NotificationCompatJellybean.getExtras(paramNotification))
    {
      return paramNotification.getString("android.support.sortKey");
      if (Build.VERSION.SDK_INT < 16) {
        break;
      }
    }
  ...
  public static boolean isGroupSummary(Notification paramNotification)
  {
    ...
    for (paramNotification = paramNotification.extras;; paramNotification = NotificationCompatJellybean.getExtras(paramNotification))
    {
      return paramNotification.getBoolean("android.support.isGroupSummary");
      if (Build.VERSION.SDK_INT < 16) {
        break;
      }
    }
  ...
  public static class Action
  {
    ...
    public static final class Builder
    {
      ...
      public final Builder setSemanticAction(int paramInt)
      {
        this.mSemanticAction = paramInt;
        return this;
      }
      
      public final Builder setShowsUserInterface(boolean paramBoolean)
      {
      ...
      implements NotificationCompat.Action.Extender
    {
      ...
      {
        if (paramBoolean) {
          paramInt |= this.mFlags;
        }
        for (;;)
        {
          this.mFlags = paramInt;
          return;
          paramInt = (paramInt ^ 0xFFFFFFFF) & this.mFlags;
        }
      }
  ...
  public static class Builder
  {
    ...
    private void setFlag(int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        return;
        localNotification = this.mNotification;
        paramInt = (paramInt ^ 0xFFFFFFFF) & localNotification.flags;
      }
    }
    ...
    implements NotificationCompat.Extender
  {
    ...
    private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle paramBundle)
    {
      ...
      Object localObject3 = paramBundle.getParcelableArray("messages");
      String[] arrayOfString1;
      if (localObject3 != null)
      {
        arrayOfString1 = new String[localObject3.length];
        int j = 0;
        int i = 0;
        while (i < arrayOfString1.length)
        {
          if (!(localObject3[i] instanceof Bundle))
          {
            i = j;
            break label92;
          }
          arrayOfString1[i] = ((Bundle)localObject3[i]).getString("text");
      ...
      localObject3 = (PendingIntent)paramBundle.getParcelable("on_read");
      ...
      if (arrayOfString2 != null)
      {
        ...
        if (localRemoteInput != null) {
          localObject1 = new RemoteInput(localRemoteInput.getResultKey(), localRemoteInput.getLabel(), localRemoteInput.getChoices(), localRemoteInput.getAllowFreeFormInput(), localRemoteInput.getExtras(), null);
        }
        localObject1 = new UnreadConversation(arrayOfString1, (RemoteInput)localObject1, localPendingIntent, (PendingIntent)localObject3, arrayOfString2, paramBundle.getLong("timestamp"));
      }
    ...
    extends NotificationCompat.Style
  {
    ...
    public void apply(NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor)
    {
      ...
      if (Build.VERSION.SDK_INT >= 24)
      {
        ...
        localObject3 = this.mMessages.iterator();
        while (((Iterator)localObject3).hasNext())
        {
          Message localMessage = (Message)((Iterator)localObject3).next();
          if (Build.VERSION.SDK_INT >= 28)
          {
      ...
      Object localObject3 = findLatestIncomingMessage();
      if ((this.mConversationTitle != null) && (this.mIsGroupConversation.booleanValue())) {
        localObject1 = paramNotificationBuilderWithBuilderAccessor.getBuilder();
      }
      for (Object localObject2 = this.mConversationTitle;; localObject2 = ((Message)localObject3).getPerson().getName())
      {
        ...
        if (((Message)localObject3).getPerson() == null) {
          break;
        }
        localObject1 = paramNotificationBuilderWithBuilderAccessor.getBuilder();
      }
      if (localObject3 != null)
      {
        ...
        if (this.mConversationTitle != null) {
          localObject1 = makeMessageLine((Message)localObject3);
        } else {
          localObject1 = ((Message)localObject3).getText();
        }
    ...
    protected void restoreFromCompatExtras(Bundle paramBundle)
    {
      ...
      for (Object localObject = Person.fromBundle(paramBundle.getBundle("android.messagingStyleUser"));; localObject = new Person.Builder().setName(paramBundle.getString("android.selfDisplayName")).build())
      {
        this.mUser = ((Person)localObject);
        break;
      }
  ...
  public static abstract class Style
  {
    ...
    public RemoteViews applyStandardTemplate(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
    {
      ...
      if ((Build.VERSION.SDK_INT >= 16) && (Build.VERSION.SDK_INT < 21))
      {
        ...
        for (paramInt = R.drawable.notification_template_icon_low_bg;; paramInt = R.drawable.notification_template_icon_bg)
        {
          localRemoteViews.setInt(i, "setBackgroundResource", paramInt);
          break;
      ...
      {
        paramInt = R.id.info;
        localObject = this.mBuilder.mContentInfo;
      ...
      for (;;)
      {
        ...
        {
          paramInt = R.id.info;
          localObject = localResources.getString(R.string.status_bar_notification_info_overflow);
          break;
        }
      ...
      if (!this.mActions.isEmpty()) {
        if (Build.VERSION.SDK_INT >= 16)
        {
          ...
          if (localIterator.hasNext())
          {
            ...
            if (Build.VERSION.SDK_INT >= 20) {}
            for (localObject = getActionFromActionCompat((NotificationCompat.Action)localObject);; localObject = NotificationCompatJellybean.getBundleForAction((NotificationCompat.Action)localObject))
            {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/NotificationCompat.class
