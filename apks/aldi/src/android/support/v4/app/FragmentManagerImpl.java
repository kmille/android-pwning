  ...
  implements LayoutInflater.Factory2
{
  ...
  private void executePostponedTransaction(ArrayList<BackStackRecord> paramArrayList, ArrayList<Boolean> paramArrayList1)
  {
    ...
    while (i < j)
    {
      ...
      do
      {
        ...
        k = paramArrayList.indexOf(localStartEnterTransitionListener.mRecord);
      } while ((k != -1) && (((Boolean)paramArrayList1.get(k)).booleanValue()));
  ...
  private static Animation.AnimationListener getAnimationListener(Animation paramAnimation)
  {
    ...
    {
      paramAnimation = "Cannot access Animation's mListener field";
    }
    catch (NoSuchFieldException localNoSuchFieldException)
    {
      paramAnimation = "No field with the name mListener is found in Animation class";
    }
    Log.e("FragmentManager", paramAnimation, localNoSuchFieldException);
    return null;
  }
  ...
  private void throwException(RuntimeException paramRuntimeException)
  {
    ...
    if (this.mHost != null) {
      ...
      dump("  ", null, localException, new String[0]);
    }
  ...
  final void completeExecute(BackStackRecord paramBackStackRecord, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (paramBoolean1) {
  ...
  final void dispatchOnFragmentActivityCreated(@NonNull Fragment paramFragment, @Nullable Bundle paramBundle, boolean paramBoolean)
  {
  ...
  final void dispatchOnFragmentAttached(@NonNull Fragment paramFragment, @NonNull Context paramContext, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentCreated(@NonNull Fragment paramFragment, @Nullable Bundle paramBundle, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentDestroyed(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentDetached(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentPaused(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentPreAttached(@NonNull Fragment paramFragment, @NonNull Context paramContext, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentPreCreated(@NonNull Fragment paramFragment, @Nullable Bundle paramBundle, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentResumed(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentSaveInstanceState(@NonNull Fragment paramFragment, @NonNull Bundle paramBundle, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentStarted(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentStopped(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentViewCreated(@NonNull Fragment paramFragment, @NonNull View paramView, @Nullable Bundle paramBundle, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  final void dispatchOnFragmentViewDestroyed(@NonNull Fragment paramFragment, boolean paramBoolean)
  {
    if (this.mParent != null)
    {
      localObject = this.mParent.getFragmentManager();
  ...
  public final boolean execPendingActions()
  {
    ...
    //   16: invokespecial 1235	android/support/v4/app/FragmentManagerImpl:generateOpsForPendingActions	(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    //   19: ifeq +36 -> 55
    //   22: aload_0
    //   23: iconst_1
  ...
  @Nullable
  public final Fragment findFragmentByTag(@Nullable String paramString)
  {
    int i;
    Fragment localFragment;
    if (paramString != null)
  ...
  final void moveToState(Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
        ...
        if (paramInt3 > 1)
        {
          ...
          if (!paramFragment.mFromLayout) {
            if (paramFragment.mContainerId != 0)
            {
              ...
              {
                localObject = new StringBuilder("Cannot create fragment ");
                ((StringBuilder)localObject).append(paramFragment);
    ...
    localStringBuilder = new StringBuilder("No view found for id 0x");
    ...
    {
      localObject = new StringBuilder("moveToState: Fragment state for ");
      ((StringBuilder)localObject).append(paramFragment);
      ((StringBuilder)localObject).append(" not updated inline; expected state ");
  ...
  public final void popBackStack(@Nullable String paramString, int paramInt)
  {
  ...
  public final boolean popBackStackImmediate(@Nullable String paramString, int paramInt)
  {
    checkStateLoss();
  ...
  final boolean popBackStackState(ArrayList<BackStackRecord> paramArrayList, ArrayList<Boolean> paramArrayList1, String paramString, int paramInt1, int paramInt2)
  {
    ...
    else
    {
      ...
      while (i >= 0)
      {
        localBackStackRecord = (BackStackRecord)this.mBackStack.get(i);
      ...
      if ((paramInt2 & 0x1) != 0) {
        for (;;)
        {
          ...
          {
            i = paramInt2;
            if (paramString.equals(localBackStackRecord.getName())) {}
          }
          else
          {
            j = paramInt2;
  ...
  final void restoreAllState(Parcelable paramParcelable, FragmentManagerNonConfig arg2)
  {
        ...
        if (localObject1 != null)
        {
          ...
          if ((((Fragment)localObject1).mState > 0) && (((FragmentState)localObject2).mSavedFragmentState == null))
          {
            ...
            if (((Fragment)localObject1).mTarget != null)
            {
              ...
              {
                localStringBuilder = new StringBuilder("Failure saving state: ");
          ...
          if (DEBUG)
          {
            localStringBuilder = new StringBuilder("Saved state of ");
            localStringBuilder.append(localObject1);
            localStringBuilder.append(": ");
  ...
  public final String toString()
  {
    ...
    if (this.mParent != null) {}
    for (Object localObject = this.mParent;; localObject = this.mHost)
    {
      DebugUtils.buildShortClassTag(localObject, localStringBuilder);
      break;
    }
    localStringBuilder.append("}}");
  ...
  static class EndViewTransitionAnimator
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/FragmentManagerImpl.class
