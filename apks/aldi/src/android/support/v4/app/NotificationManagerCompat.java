...
public final class NotificationManagerCompat
{
  ...
  public final void cancel(@Nullable String paramString, int paramInt)
  {
  ...
  public final void notify(int paramInt, @NonNull Notification paramNotification)
  {
    notify(null, paramInt, paramNotification);
  }
  
  public final void notify(@Nullable String paramString, int paramInt, @NonNull Notification paramNotification)
  {
    ...
    implements ServiceConnection, Handler.Callback
  {
    ...
    private boolean ensureServiceBound(ListenerRecord paramListenerRecord)
    {
      ...
      {
        new StringBuilder("Unable to bind to listener ").append(paramListenerRecord.componentName);
    ...
    private void processListenerQueue(ListenerRecord paramListenerRecord)
    {
      ...
      {
        localObject = new StringBuilder("Processing component ");
      ...
      for (Object localObject = new StringBuilder("RemoteException communicating with ");; localObject = new StringBuilder("Remote service has died: "))
      {
        ((StringBuilder)localObject).append(paramListenerRecord.componentName);
        break;
        if (!Log.isLoggable("NotifManCompat", 3)) {
    ...
    private void scheduleListenerRetry(ListenerRecord paramListenerRecord)
    {
      ...
      {
        localStringBuilder = new StringBuilder("Giving up on delivering ");
      ...
      if (Log.isLoggable("NotifManCompat", 3))
      {
        localStringBuilder = new StringBuilder("Scheduling retry for ");
    ...
    private void updateListenerMap()
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        {
          ComponentName localComponentName = new ComponentName(((ResolveInfo)localObject3).serviceInfo.packageName, ((ResolveInfo)localObject3).serviceInfo.name);
          if (((ResolveInfo)localObject3).serviceInfo.permission != null)
          {
            localObject3 = new StringBuilder("Permission present on component ");
            ((StringBuilder)localObject3).append(localComponentName);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/NotificationManagerCompat.class
