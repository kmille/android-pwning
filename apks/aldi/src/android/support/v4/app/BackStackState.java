  ...
  implements Parcelable
{
  ...
  public final BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl)
  {
    ...
    while (j < this.mOps.length)
    {
      ...
      k = localObject[k];
      if (k >= 0) {}
      for (localObject = (Fragment)paramFragmentManagerImpl.mActive.get(k);; localObject = null)
      {
        localOp.fragment = ((Fragment)localObject);
        break;
      }
      localObject = this.mOps;
      k = j + 1;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/BackStackState.class
