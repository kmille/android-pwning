  ...
  implements Iterable<Intent>
{
  ...
  @NonNull
  public final TaskStackBuilder addNextIntent(@NonNull Intent paramIntent)
  {
  ...
  @NonNull
  public final TaskStackBuilder addNextIntentWithParentStack(@NonNull Intent paramIntent)
  {
  ...
  @NonNull
  public final TaskStackBuilder addParentStack(@NonNull Activity paramActivity)
  {
    Object localObject1;
  ...
  public final TaskStackBuilder addParentStack(ComponentName paramComponentName)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        localObject = NavUtils.getParentActivityIntent(paramComponentName, (ComponentName)localObject);
        if (localObject == null) {
          break;
        }
        this.mIntents.add(i, localObject);
        paramComponentName = this.mSourceContext;
  ...
  @NonNull
  public final TaskStackBuilder addParentStack(@NonNull Class<?> paramClass)
  {
  ...
  @Nullable
  public final PendingIntent getPendingIntent(int paramInt1, int paramInt2, @Nullable Bundle paramBundle)
  {
  ...
  public final void startActivities(@Nullable Bundle paramBundle)
  {
    if (!this.mIntents.isEmpty())
    {
      Intent[] arrayOfIntent = (Intent[])this.mIntents.toArray(new Intent[this.mIntents.size()]);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/app/TaskStackBuilder.class
