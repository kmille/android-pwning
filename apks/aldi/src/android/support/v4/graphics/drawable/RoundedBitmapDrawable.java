  ...
  extends Drawable
{
  ...
  RoundedBitmapDrawable(Resources paramResources, Bitmap paramBitmap)
  {
    ...
    for (paramResources = new BitmapShader(paramResources, paramBitmap, paramBitmap);; paramResources = null)
    {
      this.mBitmapShader = paramResources;
      return;
  ...
  public void setCornerRadius(float paramFloat)
  {
    ...
    for (BitmapShader localBitmapShader = this.mBitmapShader;; localBitmapShader = null)
    {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/graphics/drawable/RoundedBitmapDrawable.class
