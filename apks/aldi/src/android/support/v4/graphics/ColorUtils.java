...
public final class ColorUtils
{
  ...
  public static double calculateContrast(@ColorInt int paramInt1, @ColorInt int paramInt2)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("background can not be translucent: #");
  ...
  public static Color compositeColors(@NonNull Color paramColor1, @NonNull Color paramColor2)
  {
    ...
    Object localObject = new StringBuilder("Color models must match (");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/graphics/ColorUtils.class
