...
public class TypefaceCompat
{
  ...
  static
  {
    ...
    if (Build.VERSION.SDK_INT >= 28) {
      localObject = new TypefaceCompatApi28Impl();
    }
    for (;;)
    {
      sTypefaceCompatImpl = (TypefaceCompatBaseImpl)localObject;
      break;
      if (Build.VERSION.SDK_INT >= 26) {
        localObject = new TypefaceCompatApi26Impl();
      } else if ((Build.VERSION.SDK_INT >= 24) && (TypefaceCompatApi24Impl.isUsable())) {
        localObject = new TypefaceCompatApi24Impl();
      } else if (Build.VERSION.SDK_INT >= 21) {
        localObject = new TypefaceCompatApi21Impl();
      } else {
        localObject = new TypefaceCompatBaseImpl();
      }
    }
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/graphics/TypefaceCompat.class
