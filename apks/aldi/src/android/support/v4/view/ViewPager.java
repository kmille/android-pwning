  ...
  extends ViewGroup
{
  ...
  public boolean canScrollHorizontally(int paramInt)
  {
    ...
    return (paramInt > 0) && (j < (int)(i * this.mLastOffset));
  }
    ...
    while (k < this.mItems.size())
    {
      ...
      if (i4 != -1)
      {
        if (i4 == -2)
        {
          ...
          {
            i = Math.max(0, Math.min(this.mCurItem, i5 - 1));
            j = m;
            k = n;
          }
        }
    ...
    extends AccessibilityDelegateCompat
  {
    ...
    public boolean performAccessibilityAction(View paramView, int paramInt, Bundle paramBundle)
    {
      ...
      for (paramInt = ViewPager.this.mCurItem - 1;; paramInt = ViewPager.this.mCurItem + 1)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/view/ViewPager.class
