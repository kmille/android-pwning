...
public final class GestureDetectorCompat
{
  ...
  public GestureDetectorCompat(Context paramContext, GestureDetector.OnGestureListener paramOnGestureListener, Handler paramHandler)
  {
    ...
    for (paramContext = new GestureDetectorCompatImplJellybeanMr2(paramContext, paramOnGestureListener, paramHandler);; paramContext = new GestureDetectorCompatImplBase(paramContext, paramOnGestureListener, paramHandler))
    {
    ...
    implements GestureDetectorCompat.GestureDetectorCompatImpl
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      float f2 = 0.0F;
      float f4;
      for (float f1 = 0.0F; k < m; f1 = f3)
      {
        f4 = f2;
        f3 = f1;
        if (j != k)
        {
          f4 = f2 + paramMotionEvent.getX(k);
          f3 = f1 + paramMotionEvent.getY(k);
        }
        k += 1;
        f2 = f4;
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/view/GestureDetectorCompat.class
