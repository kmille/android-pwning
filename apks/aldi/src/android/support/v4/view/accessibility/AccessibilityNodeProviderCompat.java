...
public class AccessibilityNodeProviderCompat
{
  ...
  public AccessibilityNodeProviderCompat()
  {
    ...
    if (Build.VERSION.SDK_INT >= 19) {
      localObject = new AccessibilityNodeProviderApi19(this);
    }
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT >= 16) {
        localObject = new AccessibilityNodeProviderApi16(this);
      } else {
        localObject = null;
      }
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/view/accessibility/AccessibilityNodeProviderCompat.class
