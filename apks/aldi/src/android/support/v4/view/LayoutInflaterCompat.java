...
public final class LayoutInflaterCompat
{
  ...
  private static void forceSetFactory2(LayoutInflater paramLayoutInflater, LayoutInflater.Factory2 paramFactory2)
  {
    if (!sCheckedField)
    {
      ...
      {
        StringBuilder localStringBuilder2 = new StringBuilder("forceSetFactory2 Could not find field 'mFactory2' on class ");
    ...
    if (sLayoutInflaterFactory2Field != null) {
      ...
      {
        StringBuilder localStringBuilder1 = new StringBuilder("forceSetFactory2 could not set the Factory2 on LayoutInflater ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/view/LayoutInflaterCompat.class
