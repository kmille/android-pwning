  ...
  extends ViewGroup
{
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    this.mPrevText.layout(j, i, m + j, this.mPrevText.getMeasuredHeight() + i);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/view/PagerTitleStrip.class
