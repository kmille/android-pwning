  ...
  implements AudioAttributesImpl
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return (this.mContentType == ((AudioAttributesImplBase)paramObject).getContentType()) && (this.mFlags == ((AudioAttributesImplBase)paramObject).getFlags()) && (this.mUsage == ((AudioAttributesImplBase)paramObject).getUsage()) && (this.mLegacyStream == ((AudioAttributesImplBase)paramObject).mLegacyStream);
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/AudioAttributesImplBase.class
