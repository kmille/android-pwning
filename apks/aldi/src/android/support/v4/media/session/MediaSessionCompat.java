...
public class MediaSessionCompat
{
    ...
    if (paramContext != null)
    {
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        if (paramComponentName == null) {
          localComponentName = MediaButtonReceiver.getMediaButtonReceiverComponent(paramContext);
        }
        ...
        for (paramString = new Callback() {};; paramString = new Callback() {})
        {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
          paramString = new MediaSessionImplApi19(paramContext, paramString, localComponentName, paramComponentName);
        }
        for (;;)
        {
          ...
          if (Build.VERSION.SDK_INT >= 18) {
            paramString = new MediaSessionImplApi18(paramContext, paramString, localComponentName, paramComponentName);
          } else {
            paramString = new MediaSessionImplBase(paramContext, paramString, localComponentName, paramComponentName);
          }
        }
        label235:
        this.mController = new MediaControllerCompat(paramContext, this);
  ...
  {
    MediaSessionImpl localMediaSessionImpl;
    if (paramCallback == null)
    {
      localMediaSessionImpl = this.mImpl;
      paramHandler = null;
  ...
  public static abstract class Callback
  {
    ...
    public Callback()
    {
      ...
      if (Build.VERSION.SDK_INT >= 24) {
        localObject = MediaSessionCompatApi24.createCallback(new StubApi24());
      }
      for (;;)
      {
        this.mCallbackObj = localObject;
        return;
        if (Build.VERSION.SDK_INT >= 23)
        {
          localObject = MediaSessionCompatApi23.createCallback(new StubApi23());
        }
        else
        {
          if (Build.VERSION.SDK_INT < 21) {
          ...
          localObject = MediaSessionCompatApi21.createCallback(new StubApi21());
        }
      }
          ...
          try
          {
            ...
            case 28: 
              if (MediaSessionCompat.MediaSessionImplBase.this.mQueue != null)
              {
                ...
                {
                  paramMessage = paramMessage.getDescription();
                  localCallback.onRemoveQueueItem(paramMessage);
                }
              }
              break;
            case 27: 
              paramMessage = (MediaDescriptionCompat)paramMessage.obj;
              break;
            case 26: 
    ...
    implements Parcelable
  {
    ...
    @RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public final void setExtraBinder(IMediaSession paramIMediaSession)
    {
      this.mExtraBinder = paramIMediaSession;
    }
    
    @RestrictTo({android.support.annotation.RestrictTo.Scope.LIBRARY_GROUP})
    public final void setSessionToken2Bundle(Bundle paramBundle)
    {
      this.mSessionToken2Bundle = paramBundle;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/session/MediaSessionCompat.class
