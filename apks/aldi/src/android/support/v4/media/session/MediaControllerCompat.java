...
public final class MediaControllerCompat
{
  ...
  static void validateCustomAction(String paramString, Bundle paramBundle)
  {
    ...
    paramBundle = new StringBuilder("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ");
    ...
    implements IBinder.DeathRecipient
  {
    ...
    public Callback()
    {
      Object localObject;
      if (Build.VERSION.SDK_INT >= 21) {
        localObject = MediaControllerCompatApi21.createCallback(new StubApi21(this));
      }
      for (;;)
      {
        this.mCallbackObj = localObject;
        return;
        localObject = new StubCompat(this);
        this.mIControllerCallback = ((IMediaControllerCallback)localObject);
      }
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/session/MediaControllerCompat.class
