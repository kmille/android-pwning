  ...
  implements Parcelable
{
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      {
        localObject2 = PlaybackStateCompatApi21.getCustomActions(paramObject);
  ...
  public final long getCurrentPosition(Long paramLong)
  {
  ...
  public final Object getPlaybackState()
  {
    if ((this.mStateObj == null) && (Build.VERSION.SDK_INT >= 21))
    {
      ...
      if (Build.VERSION.SDK_INT >= 22) {}
      for (localObject = PlaybackStateCompatApi22.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, (List)localObject, this.mActiveItemId, this.mExtras);; localObject = PlaybackStateCompatApi21.newInstance(this.mState, this.mPosition, this.mBufferedPosition, this.mSpeed, this.mActions, this.mErrorMessage, this.mUpdateTime, (List)localObject, this.mActiveItemId))
      {
        this.mStateObj = localObject;
        break;
      }
    }
    ...
    implements Parcelable
  {
    ...
    public final String toString()
    {
      StringBuilder localStringBuilder = new StringBuilder("Action:mName='");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/session/PlaybackStateCompat.class
