  ...
  extends Service
{
  ...
  public void onCreate()
  {
    ...
    if (Build.VERSION.SDK_INT >= 28) {
      localObject = new MediaBrowserServiceImplApi28();
    }
    for (;;)
    {
      this.mImpl = ((MediaBrowserServiceImpl)localObject);
      break;
      if (Build.VERSION.SDK_INT >= 26) {
        localObject = new MediaBrowserServiceImplApi26();
      } else if (Build.VERSION.SDK_INT >= 23) {
        localObject = new MediaBrowserServiceImplApi23();
      } else if (Build.VERSION.SDK_INT >= 21) {
        localObject = new MediaBrowserServiceImplApi21();
      } else {
        localObject = new MediaBrowserServiceImplBase();
      }
    }
    this.mImpl.onCreate();
  }
  ...
  void performCustomAction(String paramString, Bundle paramBundle, ConnectionRecord paramConnectionRecord, final ResultReceiver paramResultReceiver)
  {
    ...
    paramConnectionRecord = new StringBuilder("onCustomAction must call detach() or sendResult() or sendError() before returning for action=");
  ...
  void performLoadChildren(final String paramString, final ConnectionRecord paramConnectionRecord, final Bundle paramBundle1, final Bundle paramBundle2)
  {
    paramBundle2 = new Result(paramString)
    {
      void onResultSent(List<MediaBrowserCompat.MediaItem> paramAnonymousList)
      {
        if (MediaBrowserServiceCompat.this.mConnections.get(paramConnectionRecord.callbacks.asBinder()) != paramConnectionRecord)
        {
          ...
          {
            paramAnonymousList = new StringBuilder("Not sending onLoadChildren result for connection that has been disconnected. pkg=");
        ...
        paramAnonymousList = new StringBuilder("Calling onLoadChildren() failed for id=");
        paramAnonymousList.append(paramString);
    ...
    paramBundle1 = new StringBuilder("onLoadChildren must call detach() or sendResult() before returning for package=");
    ...
    public void onLoadItem(String paramString, final MediaBrowserServiceCompatApi21.ResultWrapper<Parcel> paramResultWrapper)
    {
      paramResultWrapper = new MediaBrowserServiceCompat.Result(paramString)
      {
        ...
        void onResultSent(MediaBrowserCompat.MediaItem paramAnonymousMediaItem)
        {
          ...
          {
            localObject = paramResultWrapper;
            paramAnonymousMediaItem = null;
          }
          for (;;)
          {
            ((MediaBrowserServiceCompatApi21.ResultWrapper)localObject).sendResult(paramAnonymousMediaItem);
            return;
            localObject = Parcel.obtain();
            paramAnonymousMediaItem.writeToParcel((Parcel)localObject, 0);
            MediaBrowserServiceCompatApi21.ResultWrapper localResultWrapper = paramResultWrapper;
            paramAnonymousMediaItem = (MediaBrowserCompat.MediaItem)localObject;
            localObject = localResultWrapper;
          }
        }
      };
      ...
      MediaBrowserServiceCompat.this.mHandler.post(new Runnable()
      {
        public void run()
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            localStringBuilder = new StringBuilder("Connection for ");
  ...
  public static class Result<T>
  {
    ...
    public void detach()
    {
      if (!this.mDetachCalled)
      {
        if (!this.mSendResultCalled)
        {
          ...
          localStringBuilder = new StringBuilder("detach() called when sendError() had already been called for: ");
          localStringBuilder.append(this.mDebug);
          throw new IllegalStateException(localStringBuilder.toString());
        }
        localStringBuilder = new StringBuilder("detach() called when sendResult() had already been called for: ");
        localStringBuilder.append(this.mDebug);
        throw new IllegalStateException(localStringBuilder.toString());
      }
      StringBuilder localStringBuilder = new StringBuilder("detach() called when detach() had already been called for: ");
      localStringBuilder.append(this.mDebug);
      throw new IllegalStateException(localStringBuilder.toString());
    }
    ...
    {
      paramBundle = new StringBuilder("It is not supported to send an error for ");
    ...
    {
      paramBundle = new StringBuilder("It is not supported to send an interim update for ");
      paramBundle.append(this.mDebug);
      throw new UnsupportedOperationException(paramBundle.toString());
    }
    ...
    public void sendError(Bundle paramBundle)
    {
      ...
      paramBundle = new StringBuilder("sendError() called when either sendResult() or sendError() had already been called for: ");
      paramBundle.append(this.mDebug);
    ...
    public void sendProgressUpdate(Bundle paramBundle)
    {
      ...
      paramBundle = new StringBuilder("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
      paramBundle.append(this.mDebug);
      throw new IllegalStateException(paramBundle.toString());
    }
    ...
    public void sendResult(T paramT)
    {
      ...
      paramT = new StringBuilder("sendResult() called when either sendResult() or sendError() had already been called for: ");
  ...
  class ServiceBinderImpl
  {
    ...
    public void connect(final String paramString, final int paramInt1, final int paramInt2, final Bundle paramBundle, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      if (MediaBrowserServiceCompat.this.isValidPackage(paramString, paramInt2))
      {
        MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
        {
          public void run()
          {
            ...
            {
              localObject = new StringBuilder("No root for client ");
            ...
            try
            {
              MediaBrowserServiceCompat.this.mConnections.put(localObject, localConnectionRecord);
              ((IBinder)localObject).linkToDeath(localConnectionRecord, 0);
              if (MediaBrowserServiceCompat.this.mSession != null) {
      ...
      paramBundle = new StringBuilder("Package/uid mismatch: uid=");
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
        {
          public void run()
          {
            ...
            if (localObject == null)
            {
              new StringBuilder("getMediaItem for callback that isn't registered id=").append(paramString);
              return;
            }
    ...
    public void removeSubscription(final String paramString, final IBinder paramIBinder, final MediaBrowserServiceCompat.ServiceCallbacks paramServiceCallbacks)
    {
      MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
      {
        public void run()
        {
          ...
          {
            localObject = new StringBuilder("removeSubscription called for ");
            ((StringBuilder)localObject).append(paramString);
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
        {
          public void run()
          {
            ...
            if (localObject == null)
            {
              new StringBuilder("search for callback that isn't registered query=").append(paramString);
              return;
            }
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable()
        {
          public void run()
          {
            ...
            if (localObject == null)
            {
              localObject = new StringBuilder("sendCustomAction for callback that isn't registered action=");
              ((StringBuilder)localObject).append(paramString);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/MediaBrowserServiceCompat.class
