  ...
  implements c
{
  ...
  static int toVolumeStreamType(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("Unknown usage value ");
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (this.mImpl == null) {
      return ((AudioAttributesCompat)paramObject).mImpl == null;
    }
  ...
  public static class Builder
  {
    ...
    Builder setInternalLegacyStreamType(int paramInt)
    {
      ...
      {
      default: 
        StringBuilder localStringBuilder = new StringBuilder("Invalid stream type ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/AudioAttributesCompat.class
