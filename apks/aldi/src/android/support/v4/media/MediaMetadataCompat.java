  ...
  implements Parcelable
{
  ...
  public final MediaDescriptionCompat getDescription()
  {
    ...
    else
    {
      j = 0;
      i = 0;
      while ((j < 3) && (i < PREFERRED_DESCRIPTION_ORDER.length))
      {
  ...
  public static final class Builder
  {
    ...
    public final Builder putBitmap(String paramString, Bitmap paramBitmap)
    {
      ...
      {
        paramBitmap = new StringBuilder("The ");
    ...
    public final Builder putLong(String paramString, long paramLong)
    {
      ...
      {
        StringBuilder localStringBuilder = new StringBuilder("The ");
    ...
    public final Builder putRating(String paramString, RatingCompat paramRatingCompat)
    {
      ...
      {
        paramRatingCompat = new StringBuilder("The ");
      ...
      if (Build.VERSION.SDK_INT >= 19)
      {
        localBundle = this.mBundle;
        paramRatingCompat = (Parcelable)paramRatingCompat.getRating();
      }
      for (;;)
      {
        localBundle.putParcelable(paramString, paramRatingCompat);
        return this;
        localBundle = this.mBundle;
      }
    }
    ...
    public final Builder putString(String paramString1, String paramString2)
    {
      ...
      {
        paramString2 = new StringBuilder("The ");
    ...
    public final Builder putText(String paramString, CharSequence paramCharSequence)
    {
      ...
      {
        paramCharSequence = new StringBuilder("The ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/media/MediaMetadataCompat.class
