...
public class FontsContractCompat
{
  ...
  public static Typeface getFontSync(Context paramContext, final FontRequest paramFontRequest, @Nullable ResourcesCompat.FontCallback arg2, @Nullable final Handler paramHandler, boolean paramBoolean, int paramInt1, final int paramInt2)
  {
    ...
    {
      public final FontsContractCompat.TypefaceResult call()
        throws Exception
      {
    ...
    if (??? == null) {
      ...
      {
        public final void onReply(FontsContractCompat.TypefaceResult paramAnonymousTypefaceResult)
        {
    ...
    throws PackageManager.NameNotFoundException
  {
    ...
    if (localProviderInfo != null)
    {
      ...
      paramPackageManager = new StringBuilder("Found content provider ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/provider/FontsContractCompat.class
