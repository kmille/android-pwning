  ...
  implements CursorFilter.CursorFilterClient, Filterable
{
  ...
  void init(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    for (;;)
    {
      this.mDataSetObserver = paramContext;
      break;
      paramContext = null;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/widget/CursorAdapter.class
