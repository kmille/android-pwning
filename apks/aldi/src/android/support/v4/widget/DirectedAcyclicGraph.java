...
public final class DirectedAcyclicGraph<T>
{
  ...
  public final void addEdge(@NonNull T paramT1, @NonNull T paramT2)
  {
  ...
  public final void addNode(@NonNull T paramT)
  {
  ...
  public final boolean contains(@NonNull T paramT)
  {
    return this.mGraph.containsKey(paramT);
  }
  
  @Nullable
  public final List getIncomingEdges(@NonNull T paramT)
  {
    return (List)this.mGraph.get(paramT);
  }
  
  @Nullable
  public final List<T> getOutgoingEdges(@NonNull T paramT)
  {
    int j = this.mGraph.size();
  ...
  public final boolean hasOutgoingEdges(@NonNull T paramT)
  {
    int j = this.mGraph.size();
    int i = 0;
    while (i < j)
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/widget/DirectedAcyclicGraph.class
