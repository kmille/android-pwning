  ...
  implements Animatable
{
  ...
  public void setStyle(int paramInt)
  {
    ...
    for (float f3 = 6.0F;; f3 = 5.0F)
    {
      setSizeParameters(f4, f1, f2, f3);
      break;
      f4 = 7.5F;
      f1 = 2.5F;
      f2 = 10.0F;
  ...
  public void start()
  {
    ...
    if (this.mRing.getEndTrim() != this.mRing.getStartTrim())
    {
      ...
      localAnimator = this.mAnimator;
    }
    for (long l = 666L;; l = 1332L)
    {
  ...
  {
    if (paramFloat > 0.75F) {}
    for (int i = evaluateColorChange((paramFloat - 0.75F) / 0.25F, paramRing.getStartingColor(), paramRing.getNextColor());; i = paramRing.getStartingColor())
    {
      paramRing.setColor(i);
      return;
    }
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/widget/CircularProgressDrawable.class
