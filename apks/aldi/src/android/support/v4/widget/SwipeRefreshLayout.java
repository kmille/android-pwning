  ...
  implements NestedScrollingChild, NestedScrollingParent
{
  ...
  public void setSize(int paramInt)
  {
    ...
    DisplayMetrics localDisplayMetrics = getResources().getDisplayMetrics();
    if (paramInt == 0) {}
    for (float f = 56.0F;; f = 40.0F)
    {
      this.mCircleDiameter = ((int)(localDisplayMetrics.density * f));
      break;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/widget/SwipeRefreshLayout.class
