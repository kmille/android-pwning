...
public class ViewDragHelper
{
  ...
  private boolean checkTouchSlop(View paramView, float paramFloat1, float paramFloat2)
  {
    ...
    return (j != 0) && (Math.abs(paramFloat2) > this.mTouchSlop);
  }
  ...
  public boolean checkTouchSlop(int paramInt1, int paramInt2)
  {
    ...
    return (paramInt1 != 0) && (Math.abs(f2) > this.mTouchSlop);
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/widget/ViewDragHelper.class
