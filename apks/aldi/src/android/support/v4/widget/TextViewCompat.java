...
public final class TextViewCompat
{
  ...
  private static Field retrieveField(String paramString)
  {
    ...
    localField = null;
    localStringBuilder = new StringBuilder("Could not retrieve ");
  ...
  private static int retrieveIntFromField(Field paramField, TextView paramTextView)
  {
    ...
    paramTextView = new StringBuilder("Could not retrieve value of ");
    ...
    implements ActionMode.Callback
  {
    ...
    private boolean isSupportedActivity(ResolveInfo paramResolveInfo, Context paramContext)
    {
      ...
      if (paramResolveInfo.activityInfo.permission != null) {
        return paramContext.checkSelfPermission(paramResolveInfo.activityInfo.permission) == 0;
      }
      return true;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v4/widget/TextViewCompat.class
