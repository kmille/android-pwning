  ...
  implements Drawable.Callback, TintAwareDrawable
{
  ...
  public static ChipDrawable createFromResource(Context paramContext, @XmlRes int paramInt)
  {
    ...
    {
      Object localObject = new StringBuilder("Can't load chip resource ID #0x");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/chip/ChipDrawable.class
