  ...
  implements ChipDrawable.Delegate
{
  ...
  private boolean handleAccessibilityExit(MotionEvent paramMotionEvent)
  {
    if (paramMotionEvent.getAction() == 10) {
      ...
      catch (NoSuchMethodException|IllegalAccessException|InvocationTargetException|NoSuchFieldException paramMotionEvent)
      {
  ...
  {
    if (paramBoolean) {}
    for (int i = -1;; i = Integer.MIN_VALUE)
    {
      setFocusedVirtualView(i);
      break;
    }
    invalidate();
    ...
    if (i != 61)
    {
      if (i != 66) {
        ...
        case 22: 
          ...
          bool1 = ViewUtils.isLayoutRtl(this) ^ true;
          break;
        case 21: 
          bool1 = bool2;
          if (!paramKeyEvent.hasNoModifiers()) {
    ...
    public void onPopulateNodeForVirtualView(int paramInt, AccessibilityNodeInfoCompat paramAccessibilityNodeInfoCompat)
    {
      if (Chip.this.hasCloseIcon())
      {
        ...
        for (;;)
        {
          ...
          localObject = localContext.getString(paramInt, new Object[] { localObject }).trim();
        }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/chip/Chip.class
