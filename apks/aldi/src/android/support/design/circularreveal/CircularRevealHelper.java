...
public class CircularRevealHelper
{
  ...
  private boolean shouldDrawCircularReveal()
  {
    ...
    if (STRATEGY == 0) {
      return (i == 0) && (this.hasCircularRevealCache);
    }
    return i == 0;
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    if (shouldDrawCircularReveal())
    {
      ...
      {
      default: 
        paramCanvas = new StringBuilder("Unsupported strategy ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/circularreveal/CircularRevealHelper.class
