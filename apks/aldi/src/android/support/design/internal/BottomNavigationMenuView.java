  ...
  implements MenuView
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt2 = 0;
    int i;
    for (paramInt4 = 0; paramInt2 < j; paramInt4 = i)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        {
          i = paramInt3 - paramInt1 - paramInt4;
          localView.layout(i - localView.getMeasuredWidth(), 0, i, k);
        }
        else
        {
          localView.layout(paramInt4, 0, localView.getMeasuredWidth() + paramInt4, k);
        }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/internal/BottomNavigationMenuView.class
