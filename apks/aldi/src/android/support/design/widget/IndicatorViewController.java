...
final class IndicatorViewController
{
  ...
  final void addIndicator(TextView paramTextView, int paramInt)
  {
  ...
  final boolean isCaptionView(int paramInt)
  {
    if (paramInt != 0) {
      return paramInt == 1;
    }
  ...
  final void removeIndicator(TextView paramTextView, int paramInt)
  {
  ...
  final void setErrorEnabled(boolean paramBoolean)
  {
  ...
  final void setErrorTextAppearance(@StyleRes int paramInt)
  {
  ...
  final void setErrorViewTextColor(@Nullable ColorStateList paramColorStateList)
  {
    if (this.errorView != null) {
  ...
  final void setHelperTextAppearance(@StyleRes int paramInt)
  {
  ...
  final void setHelperTextEnabled(boolean paramBoolean)
  {
  ...
  final void setHelperTextViewTextColor(@Nullable ColorStateList paramColorStateList)
  {
    if (this.helperTextView != null) {
  ...
  final void showError(CharSequence paramCharSequence)
  {
    cancelCaptionAnimator();
  ...
  final void showHelper(CharSequence paramCharSequence)
  {
    cancelCaptionAnimator();
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/IndicatorViewController.class
