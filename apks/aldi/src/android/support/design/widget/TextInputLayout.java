  ...
  extends LinearLayout
{
  ...
  private void assignBoxBackgroundByMode()
  {
    ...
    for (CutoutDrawable localCutoutDrawable = null;; localCutoutDrawable = new CutoutDrawable())
    {
      this.boxBackground = localCutoutDrawable;
      return;
  ...
  private void updateLabelState(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    int j = 1;
    int i;
    if ((localObject != null) && (!TextUtils.isEmpty(this.editText.getText()))) {
      i = 1;
    } else {
      i = 0;
    }
    ...
    else
    {
      ...
      if (bool2)
      {
        ...
        localColorStateList = this.indicatorViewController.getErrorViewTextColors();
      }
      for (;;)
      {
        ((CollapsingTextHelper)localObject).setCollapsedTextColor(localColorStateList);
        break;
        if ((this.counterOverflowed) && (this.counterView != null))
        {
          localObject = this.collapsingTextHelper;
          localColorStateList = this.counterView.getTextColors();
        }
        else
        {
          if ((j == 0) || (this.focusedTextColor == null)) {
            break;
          }
          localObject = this.collapsingTextHelper;
          localColorStateList = this.focusedTextColor;
        }
      }
    }
  ...
  public void passwordVisibilityToggleRequested(boolean paramBoolean)
  {
    if (this.passwordToggleEnabled)
    {
      ...
      {
        this.passwordToggledVisible = bool;
        break;
  ...
  public void setCounterEnabled(boolean paramBoolean)
  {
    if (this.counterEnabled != paramBoolean)
    {
      if (paramBoolean)
      {
        ...
        if (this.editText == null) {}
        for (int i = 0;; i = this.editText.getText().length())
        {
          updateCounter(i);
          break;
        }
    ...
    if (this.boxBackground != null)
    {
      ...
      if (this.boxBackgroundMode == 2)
      {
        ...
        for (;;)
        {
          ...
          break;
          if (this.indicatorViewController.errorShouldBeShown()) {
            i = this.indicatorViewController.getErrorViewCurrentTextColor();
          } else if ((this.counterOverflowed) && (this.counterView != null)) {
            i = this.counterView.getCurrentTextColor();
          } else if (j != 0) {
    ...
    extends AbsSavedState
  {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator()
    {
      ...
      public final TextInputLayout.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
    ...
    {
      StringBuilder localStringBuilder = new StringBuilder("TextInputLayout.SavedState{");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/TextInputLayout.class
