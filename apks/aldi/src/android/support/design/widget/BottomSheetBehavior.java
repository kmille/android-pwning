  ...
  extends CoordinatorLayout.Behavior<V>
{
  ...
  private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback()
  {
    ...
    public void onViewReleased(@NonNull View paramAnonymousView, float paramAnonymousFloat1, float paramAnonymousFloat2)
    {
      ...
      if (paramAnonymousFloat2 < 0.0F)
      {
        ...
        label31:
        while (paramAnonymousView.getTop() <= BottomSheetBehavior.this.halfExpandedOffset)
        {
          j = 3;
          break;
        }
      ...
      for (;;)
      {
        ...
        do
        {
          ...
          } while (Math.abs(k - BottomSheetBehavior.this.fitToContentsOffset) >= Math.abs(k - BottomSheetBehavior.this.collapsedOffset));
          break;
        ...
        } while (Math.abs(k - BottomSheetBehavior.this.halfExpandedOffset) >= Math.abs(k - BottomSheetBehavior.this.collapsedOffset));
      }
      label276:
  ...
  public BottomSheetBehavior(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if ((localTypedValue != null) && (localTypedValue.data == -1)) {
      ...
      i = paramAttributeSet.getDimensionPixelSize(R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1);
    }
    setPeekHeight(i);
  ...
  private void calculateCollapsedOffset()
  {
    ...
    for (int i = Math.max(this.parentHeight - this.lastPeekHeight, this.fitToContentsOffset);; i = this.parentHeight - this.lastPeekHeight)
    {
    ...
    while (i < k)
    {
      ...
      if (localView != this.viewRef.get())
      {
        ...
        if (!paramBoolean)
        {
          ...
          j = ((Integer)this.importantForAccessibilityMap.get(localView)).intValue();
        }
        else
        {
        ...
        ViewCompat.setImportantForAccessibility(localView, j);
      }
      label192:
      i += 1;
    }
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent)
  {
    ...
    return (i == 2) && (paramV != null) && (!this.ignoreEvents) && (this.state != 1) && (!paramCoordinatorLayout.isPointInChildBounds(paramV, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY())) && (this.viewDragHelper != null) && (Math.abs(this.initialY - paramMotionEvent.getY()) > this.viewDragHelper.getTouchSlop());
  }
  ...
  public boolean onLayoutChild(CoordinatorLayout paramCoordinatorLayout, V paramV, int paramInt)
  {
    ...
    if (this.peekHeightAuto)
    {
      ...
      paramInt = Math.max(this.peekHeightMin, this.parentHeight - paramCoordinatorLayout.getWidth() * 9 / 16);
    }
    else
    {
      paramInt = this.peekHeight;
    }
    this.lastPeekHeight = paramInt;
  ...
  public void onRestoreInstanceState(CoordinatorLayout paramCoordinatorLayout, V paramV, Parcelable paramParcelable)
  {
    ...
    for (int i = paramParcelable.state;; i = 4)
    {
      this.state = i;
      return;
    }
      ...
      else
      {
        if (this.lastNestedScrollDy == 0)
        {
          ...
          else
          {
            ...
            while (Math.abs(paramInt - this.halfExpandedOffset) < Math.abs(paramInt - this.collapsedOffset))
            {
              paramInt = this.halfExpandedOffset;
              i = 6;
              break;
  ...
  void setStateInternal(int paramInt)
  {
    ...
    updateImportantForAccessibility(bool);
    label50:
    View localView = (View)this.viewRef.get();
    if ((localView != null) && (this.callback != null)) {
    ...
    extends AbsSavedState
  {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator()
    {
      ...
      public final BottomSheetBehavior.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/BottomSheetBehavior.class
