...
public final class CollapsingTextHelper
{
  ...
  private void calculateOffsets(float paramFloat)
  {
    ...
    if (this.collapsedTextColor != this.expandedTextColor) {
      localTextPaint = this.textPaint;
    }
    for (int i = blendColors(getCurrentExpandedTextColor(), getCurrentCollapsedTextColor(), paramFloat);; i = getCurrentCollapsedTextColor())
    {
  ...
  public final void getCollapsedTextActualBounds(RectF paramRectF)
  {
  ...
  public final void setCollapsedBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  public final void setCollapsedTextAppearance(int paramInt)
  {
  ...
  public final void setCollapsedTextColor(ColorStateList paramColorStateList)
  {
  ...
  public final void setCollapsedTextGravity(int paramInt)
  {
  ...
  public final void setCollapsedTextSize(float paramFloat)
  {
  ...
  public final void setCollapsedTypeface(Typeface paramTypeface)
  {
  ...
  public final void setExpandedBounds(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
  ...
  public final void setExpandedTextAppearance(int paramInt)
  {
    TintTypedArray localTintTypedArray = TintTypedArray.obtainStyledAttributes(this.view.getContext(), paramInt, R.styleable.TextAppearance);
    if (localTintTypedArray.hasValue(R.styleable.TextAppearance_android_textColor)) {
  ...
  public final void setExpandedTextColor(ColorStateList paramColorStateList)
  {
  ...
  public final void setExpandedTextGravity(int paramInt)
  {
  ...
  public final void setExpandedTextSize(float paramFloat)
  {
  ...
  public final void setExpandedTypeface(Typeface paramTypeface)
  {
  ...
  public final void setExpansionFraction(float paramFloat)
  {
  ...
  public final void setPositionInterpolator(TimeInterpolator paramTimeInterpolator)
  {
  ...
  public final void setTextSizeInterpolator(TimeInterpolator paramTimeInterpolator)
  {
    this.textSizeInterpolator = paramTimeInterpolator;
    recalculate();
  }
  
  public final void setTypefaces(Typeface paramTypeface)
  {
    this.expandedTypeface = paramTypeface;
    this.collapsedTypeface = paramTypeface;
    recalculate();
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/CollapsingTextHelper.class
