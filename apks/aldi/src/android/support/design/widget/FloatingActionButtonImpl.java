...
class FloatingActionButtonImpl
{
  ...
  private void updateFromViewRotation()
  {
    if (Build.VERSION.SDK_INT == 19)
    {
      ...
      {
        int j = this.view.getLayerType();
        i = 1;
        if (j != 1) {
          localVisibilityAwareImageButton = this.view;
        }
      }
      else
      {
        for (;;)
        {
          localVisibilityAwareImageButton.setLayerType(i, null);
          break;
  ...
  class DisabledElevationAnimation
  ...
  class ElevateToHoveredFocusedTranslationZAnimation
    extends FloatingActionButtonImpl.ShadowAnimatorImpl
  {
  ...
  class ElevateToPressedTranslationZAnimation
    extends FloatingActionButtonImpl.ShadowAnimatorImpl
  {
  ...
  abstract class ShadowAnimatorImpl
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/FloatingActionButtonImpl.class
