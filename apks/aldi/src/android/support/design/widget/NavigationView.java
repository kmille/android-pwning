  ...
  extends ScrimInsetsFrameLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      paramInt1 = Math.min(View.MeasureSpec.getSize(paramInt1), this.maxWidth);
    }
    ...
    extends AbsSavedState
  {
    ...
    {
      public final NavigationView.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/NavigationView.class
