  ...
  extends CoordinatorLayout.Behavior<V>
{
  ...
  private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback()
  {
    ...
    public int clampViewPositionHorizontal(View paramAnonymousView, int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      label48:
      for (paramAnonymousInt2 = this.originalCapturedViewLeft;; paramAnonymousInt2 = this.originalCapturedViewLeft - paramAnonymousView.getWidth())
      {
        i = this.originalCapturedViewLeft;
        i = paramAnonymousView.getWidth() + i;
        break label102;
        if (SwipeDismissBehavior.this.swipeDirection == 1)
        {
          if (paramAnonymousInt2 == 0) {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/SwipeDismissBehavior.class
