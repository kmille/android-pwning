  ...
  extends FrameLayout
{
  ...
  private boolean isToolbarChild(View paramView)
  {
    if ((this.toolbarDirectChild != null) && (this.toolbarDirectChild != this)) {
      return paramView == this.toolbarDirectChild;
    }
    return paramView == this.toolbar;
  }
    ...
    public void onOffsetChanged(AppBarLayout paramAppBarLayout, int paramInt)
    {
      ...
      while (j < m)
      {
        ...
        default: 
          break;
        case 2: 
          k = Math.round(-paramInt * localLayoutParams.parallaxMult);
          break;
        case 1: 
          k = MathUtils.clamp(-paramInt, 0, CollapsingToolbarLayout.this.getMaxOffsetForPinChild(paramAppBarLayout));
        }
        localViewOffsetHelper.setTopAndBottomOffset(k);
        j += 1;
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/CollapsingToolbarLayout.class
