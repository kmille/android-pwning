  ...
  implements NestedScrollingParent2
{
  ...
  private int getKeyline(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localStringBuilder = new StringBuilder("Keyline index ");
      localStringBuilder.append(paramInt);
  ...
  private void offsetChildByInset(View paramView, Rect paramRect, int paramInt)
  {
    ...
    if (paramView.getWidth() > 0)
    {
      ...
      if ((localBehavior != null) && (localBehavior.getInsetDodgeRect(this, paramView, localRect1)))
      {
        ...
        {
          paramView = new StringBuilder("Rect should be within the child's bounds. Rect:");
    ...
    while (i1 < n)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if ((m != 0) && (!ViewCompat.getFitsSystemWindows(localView)))
        {
          ...
          i = View.MeasureSpec.makeMeasureSpec(i12 - (i + i16), i11);
        ...
        i = Math.max(i5, i7 + i9 + localView.getMeasuredHeight() + localLayoutParams.topMargin + localLayoutParams.bottomMargin);
  ...
  public boolean onStartNestedScroll(View paramView1, View paramView2, int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool1 = false; i < j; bool1 = bool2)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (localBehavior != null)
        {
          bool2 = localBehavior.onStartNestedScroll(this, localView, paramView1, paramView2, paramInt1, paramInt2);
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    private void resolveAnchorView(View paramView, CoordinatorLayout paramCoordinatorLayout)
    {
      ...
      while (paramCoordinatorLayout.isInEditMode())
      {
        ...
        for (localObject = this.mAnchorView.getParent();; localObject = ((ViewParent)localObject).getParent())
        {
      ...
      Object localObject = new StringBuilder("Could not find CoordinatorLayout descendant view with id ");
    ...
    extends AbsSavedState
  {
    ...
    {
      public final CoordinatorLayout.SavedState createFromParcel(Parcel paramAnonymousParcel)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/CoordinatorLayout.class
