  ...
  extends GradientDrawable
{
  ...
  private void saveCanvasLayer(@NonNull Canvas paramCanvas)
  {
    ...
    for (int i = paramCanvas.saveLayer(0.0F, 0.0F, paramCanvas.getWidth(), paramCanvas.getHeight(), null);; i = paramCanvas.saveLayer(0.0F, 0.0F, paramCanvas.getWidth(), paramCanvas.getHeight(), null, 31))
    {
      this.savedLayer = i;
      return;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/CutoutDrawable.class
