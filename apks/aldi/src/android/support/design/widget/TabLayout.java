  ...
  extends HorizontalScrollView
{
  ...
  private TabView createTabView(@NonNull Tab paramTab)
  {
    ...
    for (paramTab = paramTab.text;; paramTab = paramTab.contentDesc)
    {
      localTabView2.setContentDescription(paramTab);
    ...
    extends LinearLayout
  {
    ...
    public void draw(Canvas paramCanvas)
    {
      ...
      if ((this.indicatorLeft >= 0) && (this.indicatorRight > this.indicatorLeft))
      {
        ...
        ((Drawable)localObject).setBounds(this.indicatorLeft, m, this.indicatorRight, i);
    ...
    extends LinearLayout
  {
    ...
    final void update()
    {
      ...
      if (localObject != null)
      {
        ...
        this.customView = ((View)localObject);
        if (this.textView != null) {
        ...
        this.customTextView = ((TextView)((View)localObject).findViewById(16908308));
        if (this.customTextView != null) {
          this.defaultMaxLines = TextViewCompat.getMaxLines(this.customTextView);
        }
        this.customIconView = ((ImageView)((View)localObject).findViewById(16908294));
      }
      else
      {
        if (this.customView != null)
      ...
      Object localObject = this.customView;
      boolean bool2 = false;
      if (localObject == null)
      {
        if (this.iconView == null)
        {
          ...
          this.iconView = ((ImageView)localObject);
        }
        ...
        if (localTab != null)
        {
          ...
          if (localTab.getIcon() != null) {
            localObject = DrawableCompat.wrap(localTab.getIcon()).mutate();
          }
        }
        if (localObject != null)
        {
          DrawableCompat.setTintList((Drawable)localObject, TabLayout.this.tabIconTint);
          if (TabLayout.this.tabIconTintMode != null) {
            DrawableCompat.setTintMode((Drawable)localObject, TabLayout.this.tabIconTintMode);
          }
        }
        if (this.textView == null)
        {
      ...
      else
      {
        ...
        localObject = this.customTextView;
        localImageView = this.customIconView;
      }
      updateTextAndIcon((TextView)localObject, localImageView);
      label430:
    ...
    final void updateOrientation()
    {
      ...
      for (ImageView localImageView = this.iconView;; localImageView = this.customIconView)
      {
        updateTextAndIcon(localTextView, localImageView);
        return;
        localTextView = this.customTextView;
      }
    }
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/TabLayout.class
