  ...
  extends ViewOffsetBehavior<View>
{
  ...
  protected void layoutChild(CoordinatorLayout paramCoordinatorLayout, View paramView, int paramInt)
  {
    ...
    for (paramInt = paramCoordinatorLayout.top - localView.getBottom();; paramInt = 0)
    {
      this.verticalLayoutGap = paramInt;
      return;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/widget/HeaderScrollingViewBehavior.class
