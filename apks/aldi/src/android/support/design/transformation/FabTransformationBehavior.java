  ...
  extends ExpandableTransformationBehavior
{
  ...
  private void createElevationAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List<Animator> paramList, List<Animator.AnimatorListener> paramList1)
  {
    ...
    if (paramBoolean1)
    {
      ...
      paramView1 = View.TRANSLATION_Z;
      paramList1 = new float[1];
      paramList1[0] = 0.0F;
    }
    else
    {
    ...
    paramView1 = ObjectAnimator.ofFloat(paramView2, paramView1, paramList1);
  ...
  private void createIconFadeAnimation(View paramView1, final View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List<Animator> paramList, List<Animator.AnimatorListener> paramList1)
  {
    if ((paramView2 instanceof CircularRevealWidget))
    {
      ...
      if (paramBoolean1)
      {
        ...
        paramView1 = DrawableAlphaProperty.DRAWABLE_ALPHA_COMPAT;
      ...
      paramView1 = ObjectAnimator.ofInt(localDrawable, paramView1, arrayOfInt);
  ...
  private void createTranslationAnimation(View paramView1, View paramView2, boolean paramBoolean1, boolean paramBoolean2, FabTransformationSpec paramFabTransformationSpec, List<Animator> paramList, List<Animator.AnimatorListener> paramList1, RectF paramRectF)
  {
    ...
    if ((f1 != 0.0F) && (f2 != 0.0F))
    {
      if (((paramBoolean1) && (f2 < 0.0F)) || ((!paramBoolean1) && (f2 > 0.0F)))
      {
        ...
        paramList1 = paramFabTransformationSpec.timings;
        localObject = "translationYCurveUpwards";
      }
      else
      {
        paramView1 = paramFabTransformationSpec.timings.getTiming("translationXCurveDownwards");
        paramList1 = paramFabTransformationSpec.timings;
        localObject = "translationYCurveDownwards";
      }
    }
    else
    {
      ...
      paramList1 = paramFabTransformationSpec.timings;
      localObject = "translationYLinear";
    }
    MotionTiming localMotionTiming = paramList1.getTiming((String)localObject);
    if (paramBoolean1)
    {
      if (!paramBoolean2)
      {
      ...
      localObject = ObjectAnimator.ofFloat(paramView2, View.TRANSLATION_X, new float[] { 0.0F });
      paramList1 = ObjectAnimator.ofFloat(paramView2, View.TRANSLATION_Y, new float[] { 0.0F });
      calculateChildVisibleBoundsAtEndOfExpansion(paramView2, paramFabTransformationSpec, paramView1, localMotionTiming, -f1, -f2, 0.0F, 0.0F, paramRectF);
      paramView2 = (View)localObject;
      paramFabTransformationSpec = paramList1;
    }
    else
    {
      paramList1 = ObjectAnimator.ofFloat(paramView2, View.TRANSLATION_X, new float[] { -f1 });
    ...
    localMotionTiming.apply(paramFabTransformationSpec);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/transformation/FabTransformationBehavior.class
