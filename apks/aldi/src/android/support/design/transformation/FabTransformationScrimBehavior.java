  ...
  extends ExpandableTransformationBehavior
{
  ...
  private void createScrimAnimation(View paramView, boolean paramBoolean1, boolean paramBoolean2, List<Animator> paramList, List<Animator.AnimatorListener> paramList1)
  {
    ...
    paramView = ObjectAnimator.ofFloat(paramView, localProperty, arrayOfFloat);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/design/transformation/FabTransformationScrimBehavior.class
