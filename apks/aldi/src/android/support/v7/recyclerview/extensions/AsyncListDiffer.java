...
public class AsyncListDiffer<T>
{
  ...
  public AsyncListDiffer(@NonNull ListUpdateCallback paramListUpdateCallback, @NonNull AsyncDifferConfig<T> paramAsyncDifferConfig)
  {
    ...
    for (paramListUpdateCallback = paramAsyncDifferConfig.getMainThreadExecutor();; paramListUpdateCallback = sMainThreadExecutor)
    {
      this.mMainThreadExecutor = paramListUpdateCallback;
      return;
    }
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/recyclerview/extensions/AsyncListDiffer.class
