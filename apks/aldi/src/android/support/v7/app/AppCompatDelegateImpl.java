  ...
  implements MenuBuilder.Callback, LayoutInflater.Factory2
{
  ...
  private ViewGroup createSubDecor()
  {
    ...
    if (((TypedArray)localObject1).hasValue(R.styleable.AppCompatTheme_windowActionBar))
    {
      ...
      else
      {
        ...
        for (int i = R.layout.abc_screen_simple_overlay_action_mode;; i = R.layout.abc_screen_simple)
        {
  ...
  private void initWindowDecorActionBar()
  {
    ...
    if (this.mHasActionBar)
    {
      ...
      for (WindowDecorActionBar localWindowDecorActionBar = new WindowDecorActionBar((Activity)this.mOriginalWindowCallback, this.mOverlayActionBar);; localWindowDecorActionBar = new WindowDecorActionBar((Dialog)this.mOriginalWindowCallback))
      {
  ...
  public View createView(View paramView, String paramString, @NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet)
  {
    ...
    localStringBuilder = new StringBuilder("Failed to instantiate custom view inflater ");
    ...
    localObject = new AppCompatViewInflater();
    label133:
    this.mAppCompatViewInflater = ((AppCompatViewInflater)localObject);
    if (IS_PRE_LOLLIPOP)
    {
  ...
  public void setSupportActionBar(Toolbar paramToolbar)
  {
    ...
    if (!(localObject instanceof WindowDecorActionBar))
    {
      ...
      for (paramToolbar = paramToolbar.getWrappedWindowCallback();; paramToolbar = this.mAppCompatWindowCallback)
      {
        ((Window)localObject).setCallback(paramToolbar);
        break;
  ...
  protected static final class PanelFeatureState
  {
      ...
      implements Parcelable
    {
      ...
      {
        public final AppCompatDelegateImpl.PanelFeatureState.SavedState createFromParcel(Parcel paramAnonymousParcel)
        {
          return AppCompatDelegateImpl.PanelFeatureState.SavedState.readFromParcel(paramAnonymousParcel, null);
        }
        
        public final AppCompatDelegateImpl.PanelFeatureState.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
        {
          return AppCompatDelegateImpl.PanelFeatureState.SavedState.readFromParcel(paramAnonymousParcel, paramAnonymousClassLoader);
        }
        
        public final AppCompatDelegateImpl.PanelFeatureState.SavedState[] newArray(int paramAnonymousInt)
        {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/app/AppCompatDelegateImpl.class
