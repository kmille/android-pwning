...
class AlertController
{
  ...
  private final View.OnClickListener mButtonHandler = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      if ((paramAnonymousView == AlertController.this.mButtonPositive) && (AlertController.this.mButtonPositiveMessage != null)) {
        paramAnonymousView = AlertController.this.mButtonPositiveMessage;
      }
      for (;;)
      {
        ...
        {
          paramAnonymousView = AlertController.this.mButtonNegativeMessage;
        }
        else
        {
          if ((paramAnonymousView != AlertController.this.mButtonNeutral) || (AlertController.this.mButtonNeutralMessage == null)) {
            break;
          }
          paramAnonymousView = AlertController.this.mButtonNeutralMessage;
        }
      }
  ...
  public static class AlertParams
  {
    ...
    private void createListView(final AlertController paramAlertController)
    {
      ...
      for (Object localObject = new AdapterView.OnItemClickListener()
          {
          ...
          };; localObject = new AdapterView.OnItemClickListener()
          {
            public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
            {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/app/AlertController.class
