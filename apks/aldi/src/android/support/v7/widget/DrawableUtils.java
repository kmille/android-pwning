...
public class DrawableUtils
{
  ...
  {
    int[] arrayOfInt2 = paramDrawable.getState();
    int[] arrayOfInt1;
    if ((arrayOfInt2 != null) && (arrayOfInt2.length != 0)) {
      arrayOfInt1 = ThemeUtils.EMPTY_STATE_SET;
    } else {
      arrayOfInt1 = ThemeUtils.CHECKED_STATE_SET;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/DrawableUtils.class
