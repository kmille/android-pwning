...
class OpReorderer
{
  ...
  void swapMoveRemove(List<AdapterHelper.UpdateOp> paramList, int paramInt1, AdapterHelper.UpdateOp paramUpdateOp1, int paramInt2, AdapterHelper.UpdateOp paramUpdateOp2)
  {
    ...
    else
    {
      ...
      } while (paramUpdateOp1.itemCount >= paramUpdateOp2.positionStart);
    }
    paramList.set(paramInt1, paramUpdateOp2);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/OpReorderer.class
