  ...
  extends FrameLayout
{
  ...
  static
  {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      localObject = new CardViewApi21Impl();
    }
    for (;;)
    {
      ...
      if (Build.VERSION.SDK_INT >= 17) {
        localObject = new CardViewApi17Impl();
      } else {
        localObject = new CardViewBaseImpl();
      }
    }
    IMPL.initStatic();
  }
  ...
  public CardView(@NonNull Context paramContext, @Nullable AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    for (paramAttributeSet = localTypedArray.getColorStateList(R.styleable.CardView_cardBackgroundColor);; paramAttributeSet = ColorStateList.valueOf(paramInt))
    {
      ...
      for (paramInt = R.color.cardview_light_background;; paramInt = R.color.cardview_dark_background)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/CardView.class
