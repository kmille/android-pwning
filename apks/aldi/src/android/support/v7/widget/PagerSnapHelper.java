  ...
  extends SnapHelper
{
  ...
  public int findTargetSnapPosition(RecyclerView.LayoutManager paramLayoutManager, int paramInt1, int paramInt2)
  {
    ...
    Object localObject = null;
    if (paramLayoutManager.canScrollVertically()) {}
    for (localObject = getVerticalHelper(paramLayoutManager);; localObject = getHorizontalHelper(paramLayoutManager))
    {
    ...
    int i = paramLayoutManager.getPosition((View)localObject);
    if (i == -1) {
      return -1;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/PagerSnapHelper.class
