  ...
  implements NestedScrollingChild2, ScrollingView
{
  ...
  private boolean didChildRangeChange(int paramInt1, int paramInt2)
  {
    ...
    if (this.mMinMaxLayoutPositions[0] == paramInt1) {
      return this.mMinMaxLayoutPositions[1] != paramInt2;
    }
    return true;
  }
  ...
  private void handleMissingPreInfoForChangeError(long paramLong, ViewHolder paramViewHolder1, ViewHolder paramViewHolder2)
  {
    ...
    while (i < j)
    {
      ...
      if ((localObject != paramViewHolder1) && (getChangedHolderKey((ViewHolder)localObject) == paramLong))
      {
        ...
        {
          paramViewHolder2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
        ...
        paramViewHolder2 = new StringBuilder("Two different ViewHolders have the same change ID. This might happen due to inconsistent Adapter update events or if the LayoutManager lays out the same View multiple times.\n ViewHolder 1:");
        paramViewHolder2.append(localObject);
        paramViewHolder2.append(" \n View Holder 2:");
        paramViewHolder2.append(paramViewHolder1);
        paramViewHolder2.append(exceptionLabel());
    ...
    Object localObject = new StringBuilder("Problem while matching changed view holders with the newones. The pre-layout information for the change holder ");
        ...
        if (paramInt != 33)
        {
          if (paramInt != 66)
          {
            if (paramInt != 130)
            {
              ...
              {
              default: 
                paramView1 = new StringBuilder("Invalid direction: ");
  ...
  private void pullGlows(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    for (;;)
    {
      EdgeEffectCompat.onPull(localEdgeEffect, paramFloat3, f1);
      i = 1;
      break label104;
      if (paramFloat2 <= 0.0F) {
        break;
  ...
  void assertInLayoutOrScroll(String paramString)
  {
    if (!isComputingLayout())
    {
      if (paramString == null)
      {
        paramString = new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling");
  ...
  {
    if (this.mAdapter == null) {}
    for (String str = "No adapter attached; skipping layout";; str = "No layout manager attached; skipping layout")
    {
    ...
    while ((this.mAdapterHelper.hasUpdates()) || (this.mLayout.getWidth() != getWidth()) || (this.mLayout.getHeight() != getHeight()))
    {
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((this.mBottomGlow != null) && (!this.mBottomGlow.isFinished()))
    {
      ...
      for (i = -getHeight() + getPaddingBottom();; i = -getHeight())
      {
  ...
  void ensureBottomGlow()
  {
    ...
    for (int j = getMeasuredHeight() - getPaddingTop() - getPaddingBottom();; j = getMeasuredHeight())
    {
  ...
  void ensureLeftGlow()
  {
    ...
    for (int j = getMeasuredWidth() - getPaddingLeft() - getPaddingRight();; j = getMeasuredWidth())
    {
      localEdgeEffect.setSize(i, j);
      return;
      localEdgeEffect = this.mLeftGlow;
  ...
  public ViewHolder findViewHolderForItemId(long paramLong)
  {
    ...
    if (localObject3 != null)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject2 = localObject1;
          if (!((ViewHolder)localObject3).isRemoved())
          {
            localObject2 = localObject1;
            if (((ViewHolder)localObject3).getItemId() == paramLong) {
              if (this.mChildHelper.isHidden(((ViewHolder)localObject3).itemView)) {
                localObject2 = localObject3;
              } else {
                return (ViewHolder)localObject3;
              }
            }
          }
        }
  ...
  void initFastScroller(StateListDrawable paramStateListDrawable1, Drawable paramDrawable1, StateListDrawable paramStateListDrawable2, Drawable paramDrawable2)
  {
    ...
    paramStateListDrawable1 = new StringBuilder("Trying to set fast scroller without both required drawables.");
  ...
  protected Parcelable onSaveInstanceState()
  {
    ...
    if (this.mLayout != null) {}
    for (Parcelable localParcelable = this.mLayout.onSaveInstanceState();; localParcelable = null)
    {
      localSavedState.mLayoutState = localParcelable;
      return localSavedState;
    }
  }
  ...
  public void setLayoutManager(@Nullable LayoutManager paramLayoutManager)
  {
    ...
    if (paramLayoutManager != null) {
      ...
      {
        StringBuilder localStringBuilder = new StringBuilder("LayoutManager ");
  ...
  public void setScrollingTouchSlop(int paramInt)
  {
    ...
    {
    default: 
      StringBuilder localStringBuilder = new StringBuilder("setScrollingTouchSlop(): bad argument constant ");
      localStringBuilder.append(paramInt);
      localStringBuilder.append("; using default value");
      break;
    }
    for (paramInt = localViewConfiguration.getScaledPagingTouchSlop();; paramInt = localViewConfiguration.getScaledTouchSlop())
    {
  ...
  public static abstract class LayoutManager
  {
    ...
    private void addViewInt(View paramView, int paramInt, boolean paramBoolean)
    {
      ...
      if ((!((RecyclerView.ViewHolder)localObject).wasReturnedFromScrap()) && (!((RecyclerView.ViewHolder)localObject).isScrap()))
      {
        if (paramView.getParent() == this.mRecyclerView)
        {
          ...
          {
            localObject = new StringBuilder("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
    ...
    public void ignoreView(@NonNull View paramView)
    {
      ...
      paramView = new StringBuilder("View should be fully attached to be ignored");
    ...
    public void moveView(int paramInt1, int paramInt2)
    {
      ...
      localObject = new StringBuilder("Cannot move a child from non-existing index:");
  ...
  public final class Recycler
  {
    ...
    final void addViewHolderToRecycledViewPool(@NonNull RecyclerView.ViewHolder paramViewHolder, boolean paramBoolean)
    {
    ...
    public final void bindViewToPosition(@NonNull View paramView, int paramInt)
    {
      RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramView);
      if (localViewHolder != null)
      {
        ...
        if ((i >= 0) && (i < RecyclerView.this.mAdapter.getItemCount()))
        {
          ...
          if (paramView == null) {}
          for (paramView = RecyclerView.this.generateDefaultLayoutParams();; paramView = RecyclerView.this.generateLayoutParams(paramView))
          {
        ...
        paramView = new StringBuilder("Inconsistency detected. Invalid item position ");
      ...
      paramView = new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter");
      paramView.append(RecyclerView.this.exceptionLabel());
      throw new IllegalArgumentException(paramView.toString());
    }
    ...
    final void dispatchViewRecycled(@NonNull RecyclerView.ViewHolder paramViewHolder)
    {
    ...
    final RecyclerView.ViewHolder getScrapOrCachedViewForId(long paramLong, int paramInt, boolean paramBoolean)
    {
    ...
    final RecyclerView.ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int paramInt, boolean paramBoolean)
    {
      ...
      if (!paramBoolean)
      {
        ...
        if (localObject != null)
        {
          ...
          localObject = new StringBuilder("layout index should not be -1 after unhiding a view:");
    ...
    public final void recycleView(@NonNull View paramView)
    {
      RecyclerView.ViewHolder localViewHolder = RecyclerView.getChildViewHolderInt(paramView);
      if (localViewHolder.isTmpDetached()) {
    ...
    final void recycleViewHolderInternal(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      if ((!bool2) && (paramViewHolder.itemView.getParent() == null))
      {
        if (!paramViewHolder.isTmpDetached())
        {
          ...
          paramViewHolder = new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.");
          paramViewHolder.append(RecyclerView.this.exceptionLabel());
          throw new IllegalArgumentException(paramViewHolder.toString());
        }
        localStringBuilder = new StringBuilder("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
    ...
    final void scrapView(View paramView)
    {
      ...
      for (paramView = this.mChangedScrap;; paramView = this.mAttachedScrap)
      {
        paramView.add(localViewHolder);
        return;
    ...
    @Nullable
    final RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int paramInt, boolean paramBoolean, long paramLong)
    {
      if ((paramInt >= 0) && (paramInt < RecyclerView.this.mState.getItemCount()))
      {
              ...
              if (this.mViewCacheExtension != null)
              {
                ...
                if (localView != null)
                {
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    {
                      localObject1 = new StringBuilder("getViewForPositionAndType returned a view that is ignored. You must call stopIgnoring before returning this view.");
                  ...
                  {
                    localObject1 = new StringBuilder("getViewForPositionAndType returned a view which does not have a ViewHolder");
                    ((StringBuilder)localObject1).append(RecyclerView.this.exceptionLabel());
                    throw new IllegalArgumentException(((StringBuilder)localObject1).toString());
                  }
                }
        ...
        j = k;
        label733:
        if ((j != 0) && (!RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject1).hasAnyOfTheFlags(8192)))
        {
          ((RecyclerView.ViewHolder)localObject1).setFlags(0, 8192);
          if (RecyclerView.this.mState.mRunSimpleAnimations)
          {
            i = RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations((RecyclerView.ViewHolder)localObject1);
            localObject2 = RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, (RecyclerView.ViewHolder)localObject1, i | 0x1000, ((RecyclerView.ViewHolder)localObject1).getUnmodifiedPayloads());
    ...
    final void unscrapView(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      for (ArrayList localArrayList = this.mChangedScrap;; localArrayList = this.mAttachedScrap)
      {
    ...
    final boolean validateViewHolderForOffsetPosition(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      StringBuilder localStringBuilder = new StringBuilder("Inconsistency detected. Invalid view holder adapter position");
      localStringBuilder.append(paramViewHolder);
      localStringBuilder.append(RecyclerView.this.exceptionLabel());
      throw new IndexOutOfBoundsException(localStringBuilder.toString());
    }
    ...
    extends AbsSavedState
  {
    public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator()
    {
      ...
      public final RecyclerView.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
  ...
  public static abstract class SmoothScroller
  {
    ...
    void start(RecyclerView paramRecyclerView, RecyclerView.LayoutManager paramLayoutManager)
    {
      if (this.mStarted)
      {
        StringBuilder localStringBuilder = new StringBuilder("An instance of ");
  ...
  public static abstract class ViewHolder
  {
    ...
    void onEnteredHiddenState(RecyclerView paramRecyclerView)
    {
      ...
      for (int i = this.mPendingAccessibilityState;; i = ViewCompat.getImportantForAccessibility(this.itemView))
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/RecyclerView.class
