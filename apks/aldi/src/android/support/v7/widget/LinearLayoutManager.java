  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider, ItemTouchHelper.ViewDropHandler
{
  ...
  private View findFirstVisibleChildClosestToEnd(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (int j = getChildCount();; j = -1)
    {
      return findOneVisibleChild(i, j, paramBoolean1, paramBoolean2);
      i = getChildCount() - 1;
    }
  }
  ...
  private void layoutForPredictiveAnimations(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2)
  {
    if ((paramState.willRunPredictiveAnimations()) && (getChildCount() != 0) && (!paramState.isPreLayout()))
    {
      ...
      {
        RecyclerView.ViewHolder localViewHolder = (RecyclerView.ViewHolder)localList.get(j);
        int m = k;
        n = i;
        if (!localViewHolder.isRemoved())
        {
          n = localViewHolder.getLayoutPosition();
          m = 1;
          int i3;
          if (n < i2) {
            i3 = 1;
          ...
          if (m == -1)
          {
            m = k + this.mOrientationHelper.getDecoratedMeasurement(localViewHolder.itemView);
            n = i;
          }
          else
          {
            n = i + this.mOrientationHelper.getDecoratedMeasurement(localViewHolder.itemView);
            m = k;
          }
        }
        j += 1;
    ...
    if (!bool1)
    {
      ...
      if ((this.mPendingScrollPosition >= 0) && (this.mPendingScrollPosition < paramState.getItemCount()))
      {
        ...
        if ((this.mPendingSavedState != null) && (this.mPendingSavedState.hasValidAnchor()))
        {
          ...
          if (paramAnchorInfo.mLayoutFromEnd) {}
          for (i = this.mOrientationHelper.getEndAfterPadding() - this.mPendingSavedState.mAnchorOffset;; i = this.mOrientationHelper.getStartAfterPadding() + this.mPendingSavedState.mAnchorOffset)
          {
            paramAnchorInfo.mCoordinate = i;
            return true;
          }
        ...
        if (this.mShouldReverseLayout) {}
        for (int i = this.mOrientationHelper.getEndAfterPadding() - this.mPendingScrollPositionOffset;; i = this.mOrientationHelper.getStartAfterPadding() + this.mPendingScrollPositionOffset)
        {
          paramAnchorInfo.mCoordinate = i;
          return true;
        }
  ...
  View findOnePartiallyOrCompletelyInvisibleChild(int paramInt1, int paramInt2)
  {
    ...
    if (this.mOrientation == 0) {}
    for (ViewBoundsCheck localViewBoundsCheck = this.mHorizontalBoundCheck;; localViewBoundsCheck = this.mVerticalBoundCheck) {
      return localViewBoundsCheck.findOneViewWithinBoundFlags(paramInt1, paramInt2, i, j);
    }
  }
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    if (getChildCount() > 0)
    {
      ...
      for (i = fixLayoutStartGap(k, paramRecycler, paramState, false);; i = fixLayoutEndGap(j, paramRecycler, paramState, false))
      {
        k += i;
        m = j + i;
        break;
  ...
  static class AnchorInfo
  {
    ...
    {
      if (this.mLayoutFromEnd) {}
      for (int i = this.mOrientationHelper.getDecoratedEnd(paramView) + this.mOrientationHelper.getTotalSpaceChange();; i = this.mOrientationHelper.getDecoratedStart(paramView))
      {
        this.mCoordinate = i;
        break;
      }
    ...
    public void assignFromViewAndKeepVisibleRect(View paramView, int paramInt)
    {
      ...
      int j = this.mOrientationHelper.getDecoratedStart(paramView);
  ...
  static class LayoutState
  {
    ...
    public void assignPositionFromScrapList(View paramView)
    {
      ...
      if (paramView == null) {}
      for (int i = -1;; i = ((RecyclerView.LayoutParams)paramView.getLayoutParams()).getViewLayoutPosition())
      {
    ...
    void log()
    {
      StringBuilder localStringBuilder = new StringBuilder("avail:");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/LinearLayoutManager.class
