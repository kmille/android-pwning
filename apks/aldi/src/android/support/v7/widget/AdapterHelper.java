    ...
    if ((paramUpdateOp.cmd != 1) && (paramUpdateOp.cmd != 8))
    {
      ...
      if (j != 2)
      {
        if (j == 4) {
          ...
          throw new IllegalArgumentException("op should be remove or update.".concat(String.valueOf(paramUpdateOp)));
        }
      }
      else {
        k = 0;
  ...
  private void postponeAndUpdateViewHolders(UpdateOp paramUpdateOp)
  {
    ...
    if (i != 4)
    {
      if (i != 8)
      {
        ...
        {
        default: 
          throw new IllegalArgumentException("Unknown update op type for ".concat(String.valueOf(paramUpdateOp)));
        case 2: 
  ...
  private int updatePositionWithPostponed(int paramInt1, int paramInt2)
  {
    ...
    for (int j = paramInt1; i >= 0; j = paramInt1)
    {
      ...
      if (localUpdateOp.cmd == 8)
      {
        ...
        if ((j >= paramInt1) && (j <= k))
        {
          ...
          {
            if (paramInt2 == 1) {}
            for (paramInt1 = localUpdateOp.itemCount + 1;; paramInt1 = localUpdateOp.itemCount - 1)
            {
              localUpdateOp.itemCount = paramInt1;
              break;
              if (paramInt2 != 2) {
                break;
              }
          ...
          {
            if (paramInt2 == 1) {}
            for (paramInt1 = localUpdateOp.positionStart + 1;; paramInt1 = localUpdateOp.positionStart - 1)
            {
              localUpdateOp.positionStart = paramInt1;
              break;
              if (paramInt2 != 2) {
                break;
              }
        ...
        else
        {
          ...
          if (j < localUpdateOp.positionStart)
          {
            if (paramInt2 == 1)
            {
              ...
              paramInt1 = localUpdateOp.itemCount + 1;
            }
            else
            {
              paramInt1 = j;
    ...
    while (paramInt1 >= 0)
    {
      ...
      if (localUpdateOp.cmd == 8)
      {
        ...
        while (localUpdateOp.itemCount <= 0)
        {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/AdapterHelper.class
