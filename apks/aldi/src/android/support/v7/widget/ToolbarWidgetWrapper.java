  ...
  implements DecorToolbar
{
  ...
  private void updateToolbarLogo()
  {
    ...
    {
      if (((this.mDisplayOpts & 0x1) != 0) && (this.mLogo != null)) {
  ...
  public void setDisplayOptions(int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      if ((i & 0x8) != 0)
      {
        ...
        for (;;)
        {
          localToolbar.setSubtitle(localCharSequence);
          break;
          localToolbar = this.mToolbar;
          localCharSequence = null;
          localToolbar.setTitle(null);
          localToolbar = this.mToolbar;
        }
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ToolbarWidgetWrapper.class
