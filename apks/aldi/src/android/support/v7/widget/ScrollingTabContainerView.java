  ...
  implements AdapterView.OnItemSelectedListener
{
  ...
  public void animateToVisibility(int paramInt)
  {
    ...
    for (ViewPropertyAnimator localViewPropertyAnimator = animate().alpha(1.0F);; localViewPropertyAnimator = animate().alpha(0.0F))
    {
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((j > 1) && ((paramInt2 == 1073741824) || (paramInt2 == Integer.MIN_VALUE)))
    {
      ...
      paramInt2 = Math.min(this.mMaxTabWidth, this.mStackedTabMaxWidth);
    }
    else
    {
      paramInt2 = -1;
    }
    this.mMaxTabWidth = paramInt2;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ScrollingTabContainerView.class
