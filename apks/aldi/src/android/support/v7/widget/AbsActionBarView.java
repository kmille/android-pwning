  ...
  extends ViewGroup
{
  ...
  public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int paramInt, long paramLong)
  {
    ...
    for (ViewPropertyAnimatorCompat localViewPropertyAnimatorCompat = ViewCompat.animate(this).alpha(1.0F);; localViewPropertyAnimatorCompat = ViewCompat.animate(this).alpha(0.0F))
    {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/AbsActionBarView.class
