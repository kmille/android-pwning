...
class ViewInfoStore
{
  ...
  void process(ProcessCallback paramProcessCallback)
  {
    ...
    while (i >= 0)
    {
      ...
      } while (localInfoRecord.preInfo == null);
      RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo1 = localInfoRecord.preInfo;
      RecyclerView.ItemAnimator.ItemHolderInfo localItemHolderInfo2 = localInfoRecord.postInfo;
      paramProcessCallback.processDisappeared(localViewHolder, localItemHolderInfo1, localItemHolderInfo2);
      break label214;
      ...
      } while ((localInfoRecord.flags & 0x8) != 0);
      label214:
      InfoRecord.recycle(localInfoRecord);
      i -= 1;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ViewInfoStore.class
