  ...
  extends CompoundButton
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (paramInt1 = getPaddingTop();; paramInt1 = (getPaddingTop() + getHeight() - getPaddingBottom()) / 2 - this.mSwitchHeight / 2)
    {
      paramInt4 = this.mSwitchHeight + paramInt1;
      break;
  ...
  public void setSwitchTextAppearance(Context paramContext, int paramInt)
  {
    ...
    for (paramContext = new AllCapsTransformationMethod(getContext());; paramContext = null)
    {
      this.mSwitchTransformationMethod = paramContext;
      break;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/SwitchCompat.class
