  ...
  private int buildDropDown()
  {
    ...
    if (localObject1 == null)
    {
      ...
      if (localView != null)
      {
        ...
        {
        default: 
          localObject2 = new StringBuilder("Invalid hint position ");
    ...
    if ((!this.mDropDownAlwaysVisible) && (this.mDropDownHeight != -1))
    {
      ...
      for (k = View.MeasureSpec.makeMeasureSpec(k, 1073741824);; k = View.MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Integer.MIN_VALUE))
      {
        break label668;
        k = this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right);
        break;
      }
      label668:
      ...
      k = i;
      if (m > 0) {
        k = i + (j + (this.mDropDownList.getPaddingTop() + this.mDropDownList.getPaddingBottom()));
      }
      return m + k;
    }
    return m + j;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ListPopupWindow.class
