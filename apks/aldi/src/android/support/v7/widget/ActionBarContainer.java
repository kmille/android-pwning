  ...
  extends FrameLayout
{
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((localView != null) && (localView.getVisibility() != 8))
    {
      ...
      localView.layout(paramInt1, i - localView.getMeasuredHeight() - ((FrameLayout.LayoutParams)localObject).bottomMargin, paramInt3, i - ((FrameLayout.LayoutParams)localObject).bottomMargin);
    }
    if (this.mIsSplit)
    {
      if (this.mSplitBackground != null)
    ...
    else
    {
      ...
      if (this.mBackground != null)
      {
        ...
        if (this.mActionBarView.getVisibility() == 0)
        {
          ...
          paramInt3 = this.mActionBarView.getTop();
          paramInt1 = this.mActionBarView.getRight();
        }
        for (localObject = this.mActionBarView;; localObject = this.mContextView)
        {
          ...
          localDrawable = this.mBackground;
          paramInt2 = this.mContextView.getLeft();
          paramInt3 = this.mContextView.getTop();
          paramInt1 = this.mContextView.getRight();
        }
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if ((this.mTabContainer != null) && (this.mTabContainer.getVisibility() != 8) && (paramInt2 != 1073741824))
    {
      ...
      for (View localView = this.mActionBarView;; localView = this.mContextView)
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ActionBarContainer.class
