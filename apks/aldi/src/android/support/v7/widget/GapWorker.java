  ...
  implements Runnable
{
  ...
  {
    public final int compare(GapWorker.Task paramAnonymousTask1, GapWorker.Task paramAnonymousTask2)
    {
  ...
  public final void add(RecyclerView paramRecyclerView)
  {
    this.mRecyclerViews.add(paramRecyclerView);
  }
  
  final void postFromTraversal(RecyclerView paramRecyclerView, int paramInt1, int paramInt2)
  {
  ...
  final void prefetch(long paramLong)
  {
    buildTaskList();
    flushTasksWithDeadline(paramLong);
  }
  
  public final void remove(RecyclerView paramRecyclerView)
  {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/GapWorker.class
