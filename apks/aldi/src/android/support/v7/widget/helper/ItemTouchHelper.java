  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
    ...
    implements Animator.AnimatorListener
  {
    ...
    public void update()
    {
      ...
      for (float f = this.mViewHolder.itemView.getTranslationX();; f = this.mStartDx + this.mFraction * (this.mTargetX - this.mStartDx))
      {
        this.mX = f;
        break;
      }
      if (this.mStartDy == this.mTargetY) {}
      for (f = this.mViewHolder.itemView.getTranslationY();; f = this.mStartDy + this.mFraction * (this.mTargetY - this.mStartDy))
      {
        this.mY = f;
        return;
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/helper/ItemTouchHelper.class
