  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  void updateAppearance()
  {
    ...
    else
    {
      ...
      this.mDefaultActivityButtonImage.setImageDrawable(((ResolveInfo)localObject1).loadIcon((PackageManager)localObject2));
      if (this.mDefaultActionButtonContentDescription != 0)
      {
        localObject1 = ((ResolveInfo)localObject1).loadLabel((PackageManager)localObject2);
        localObject1 = getContext().getString(this.mDefaultActionButtonContentDescription, new Object[] { localObject1 });
    ...
    for (Object localObject2 = this.mActivityChooserContentBackground;; localObject2 = null)
    {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ActivityChooserView.class
