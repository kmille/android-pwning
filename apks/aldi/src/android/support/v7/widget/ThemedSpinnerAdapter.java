  ...
  extends SpinnerAdapter
{
  ...
  public static final class Helper
  {
    ...
    public final void setDropDownViewTheme(@Nullable Resources.Theme paramTheme)
    {
      ...
      for (;;)
      {
        this.mDropDownInflater = paramTheme;
        return;
        if (paramTheme == this.mContext.getTheme()) {
          paramTheme = this.mInflater;
        } else {
          paramTheme = LayoutInflater.from(new ContextThemeWrapper(this.mContext, paramTheme));
        }
      }
    }
  }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ThemedSpinnerAdapter.class
