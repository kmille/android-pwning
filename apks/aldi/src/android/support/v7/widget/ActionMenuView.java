  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    if ((i6 > 0) && (l2 != 0L) && ((i6 < i4 - 1) || (i != 0) || (i3 > 1)))
    {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt4 = i2 - paramInt1 - paramInt2;
    paramInt3 = 0;
    int i = 0;
    paramInt2 = 0;
    View localView;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/widget/ActionMenuView.class
