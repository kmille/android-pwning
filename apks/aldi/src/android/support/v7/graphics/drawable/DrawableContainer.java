  ...
  implements Drawable.Callback
{
  ...
  {
    if (this.mLastDrawable != null) {}
    for (Drawable localDrawable = this.mLastDrawable;; localDrawable = this.mCurrDrawable)
    {
    ...
    extends Drawable.ConstantState
  {
    ...
    DrawableContainerState(DrawableContainerState paramDrawableContainerState, DrawableContainer paramDrawableContainer, Resources paramResources)
    {
      ...
      if (paramDrawableContainerState != null)
      {
        ...
        if (paramDrawableContainerState != null) {}
        for (paramDrawableContainerState = paramDrawableContainerState.clone();; paramDrawableContainerState = new SparseArray(this.mNumChildren))
        {
          this.mDrawableFutures = paramDrawableContainerState;
          break;
        }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/graphics/drawable/DrawableContainer.class
