  ...
  extends StateListDrawable
{
    ...
    extends StateListDrawable.StateListState
  {
    ...
    AnimatedStateListState(@Nullable AnimatedStateListState paramAnimatedStateListState, @NonNull AnimatedStateListDrawableCompat paramAnimatedStateListDrawableCompat, @Nullable Resources paramResources)
    {
      ...
      for (paramAnimatedStateListState = paramAnimatedStateListState.mStateIds;; paramAnimatedStateListState = new SparseArrayCompat())
      {
        this.mStateIds = paramAnimatedStateListState;
        return;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/graphics/drawable/AnimatedStateListDrawableCompat.class
