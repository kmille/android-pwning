  ...
  extends DrawableContainer
{
    ...
    extends DrawableContainer.DrawableContainerState
  {
    ...
    StateListState(StateListState paramStateListState, StateListDrawable paramStateListDrawable, Resources paramResources)
    {
      ...
      if (paramStateListState != null) {}
      for (paramStateListState = paramStateListState.mStateSets;; paramStateListState = new int[getCapacity()][])
      {
        this.mStateSets = paramStateListState;
        return;
      }
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/graphics/drawable/StateListDrawable.class
