...
public class AsyncListUtil<T>
{
  ...
  private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback()
  {
    ...
    public void addTile(int paramAnonymousInt, TileList.Tile<T> paramAnonymousTile)
    {
      ...
      if (localTile != null)
      {
        StringBuilder localStringBuilder = new StringBuilder("duplicate tile @");
    ...
    public void removeTile(int paramAnonymousInt1, int paramAnonymousInt2)
    {
      ...
      if (localTile == null)
      {
        Log.e("AsyncListUtil", "tile not found @".concat(String.valueOf(paramAnonymousInt2)));
        return;
      }
      AsyncListUtil.this.mBackgroundProxy.recycleTile(localTile);
    }
  ...
  void updateRange()
  {
    ...
    if (this.mTmpRange[0] <= this.mTmpRange[1])
    {
      ...
      while ((this.mTmpRange[0] > this.mPrevRange[1]) || (this.mPrevRange[0] > this.mTmpRange[1]))
      {
        this.mScrollHint = 0;
        break;
      }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/util/AsyncListUtil.class
