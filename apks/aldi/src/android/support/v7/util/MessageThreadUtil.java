      ...
      private Runnable mBackgroundRunnable = new Runnable()
      {
        public void run()
        {
          for (;;)
          {
            ...
            {
            default: 
              StringBuilder localStringBuilder = new StringBuilder("Unsupported message, what=");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/util/MessageThreadUtil.class
