...
public class SortedList<T>
{
  ...
  private void addToData(int paramInt, T paramT)
  {
    if (paramInt <= this.mSize)
    {
      ...
      {
        arrayOfObject = (Object[])Array.newInstance(this.mTClass, this.mData.length + 10);
      ...
      else
      {
        ...
        System.arraycopy(arrayOfObject, paramInt, arrayOfObject, paramInt + 1, this.mSize - paramInt);
        this.mData[paramInt] = paramT;
      }
      this.mSize += 1;
      return;
    }
    paramT = new StringBuilder("cannot add item to ");
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        for (;;)
        {
          replaceAllInsert(?);
          break;
          if (this.mCallback.areItemsTheSame(localObject, ?)) {
            break label294;
          }
          replaceAllRemove();
        }
    ...
    throws IndexOutOfBoundsException
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder("Asked to get item at ");
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/util/SortedList.class
