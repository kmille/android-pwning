  ...
  implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener
{
  ...
  public final void onCloseMenu(MenuBuilder paramMenuBuilder, boolean paramBoolean)
  {
    ...
    if (j > 0) {}
    for (i = ((CascadingMenuInfo)this.mShowingMenus.get(j - 1)).position;; i = getInitialMenuPosition())
    {
      this.mLastPosition = i;
      break;
    }
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/view/menu/CascadingMenuPopup.class
