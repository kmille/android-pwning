  ...
  extends ContextWrapper
{
  ...
  private Resources getResourcesInternal()
  {
    if (this.mResources == null)
    {
      ...
      for (Resources localResources = super.getResources();; localResources = createConfigurationContext(this.mOverrideConfiguration).getResources())
      {
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/view/ContextThemeWrapper.class
