  ...
  extends MenuInflater
{
  ...
  public void inflate(@android.support.annotation.LayoutRes int paramInt, Menu paramMenu)
  {
    ...
    //   36: aload 4
    //   38: aload 4
    //   40: invokestatic 181	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   43: aload_2
    //   44: invokespecial 149	android/support/v7/view/SupportMenuInflater:parseMenu	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   47: aload 4
    //   49: ifnull +10 -> 59
    //   52: aload 4
    ...
    //   86: aload 5
    //   88: astore_3
    //   89: new 188	android/view/InflateException
    //   92: dup
    //   93: ldc -66
    //   95: aload_2
    //   96: invokespecial 193	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   99: athrow
    //   100: new 188	android/view/InflateException
    //   103: dup
    //   104: ldc -66
    //   106: aload_2
    //   107: invokespecial 193	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   110: athrow
    //   111: aload_3
    //   112: ifnull +9 -> 121
    //   115: aload_3
  ...
  class MenuState
  {
    ...
    private <T> T newInstance(String paramString, Class<?>[] paramArrayOfClass, Object[] paramArrayOfObject)
    {
      try
      {
        paramString = SupportMenuInflater.this.mContext.getClassLoader().loadClass(paramString).getConstructor(paramArrayOfClass);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/android/support/v7/view/SupportMenuInflater.class
