...
public abstract class TopUpActivityModule
{
  ...
  @Provides
  static TopUpActivityPresenter provideTopUpActivityPresenter()
  {
    return new TopUpActivityPresenter();
  }
  
  @Binds
  public abstract IB2pView b2pView(TopUpActivity paramTopUpActivity);
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/de/eplus/mappecc/client/android/common/dependencyinjection/activity/TopUpActivityModule.class
