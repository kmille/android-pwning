  ...
  implements Serializable
{
  ...
  public p(A paramA, B paramB, C paramC)
  {
    this.a = paramA;
    this.b = paramB;
    this.c = paramC;
  ...
  public final boolean equals(Object paramObject)
  {
    if (this != paramObject) {
      if ((paramObject instanceof p))
      {
        ...
        if ((b.f.b.j.a(this.a, ((p)paramObject).a)) && (b.f.b.j.a(this.b, ((p)paramObject).b)) && (b.f.b.j.a(this.c, ((p)paramObject).c))) {}
      }
      else
      {
        return false;
...
/* Location:              /home/kmille/projects/android-pwning/apks/aldi/ALDI TALK_v6.2.1_apkpure.com-dex2jar.jar!/b/p.class
